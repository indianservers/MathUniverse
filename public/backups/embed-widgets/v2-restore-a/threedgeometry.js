/* Math Universe embed widget: ThreeDGeometry (threedgeometry.js)
 * Usage: ThreeDGeometry.embed(element, { objects:[{type,x,y,size,...}] })
 */
(function(root){
"use strict";
var KIND="threedgeometry";
var API="ThreeDGeometry";
