# Audit Report - Calculus Proof Template

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Calculus Proof Template |
| Concept Area | calculus |
| File Path | src/visual-proofs/proofs/calculus/CalculusProofTemplate.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/calculus/CalculusProofTemplate.tsx (356 lines).
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/visual-proofs/proofs/calculus/CalculusProofTemplate.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/visual-proofs/proofs/calculus/CalculusProofTemplate.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Calculus Proof Template before you move the control?
