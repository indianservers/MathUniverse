# Audit Report - Coordinate Proof Configs

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Coordinate Proof Configs |
| Concept Area | coordinate geometry |
| File Path | src/visual-proofs/proofs/coordinate-geometry/coordinateProofConfigs.ts |
...
- Source file was inspected: src/visual-proofs/proofs/coordinate-geometry/coordinateProofConfigs.ts (214 lines).
...
|---|---|---|---|
| No adjacent automated test found. | src/visual-proofs/proofs/coordinate-geometry/coordinateProofConfigs.ts | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Coordinate Proof Configs before you move the control?
