# Audit Report - Permutations Combinations Visualizer

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Permutations Combinations Visualizer |
| Concept Area | route page |
| File Path | src/pages/PermutationsCombinationsVisualizer.tsx |
| Route / Page | /math/permutations-combinations |
...
- Source file was inspected: src/pages/PermutationsCombinationsVisualizer.tsx (484 lines).
...
- src/pages/PermutationsCombinationsVisualizer.tsx
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/pages/PermutationsCombinationsVisualizer.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/pages/PermutationsCombinationsVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Permutations Combinations Visualizer before you move the control?
