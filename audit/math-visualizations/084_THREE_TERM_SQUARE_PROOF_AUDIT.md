# Audit Report - Three Term Square Proof

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Three Term Square Proof |
| Concept Area | algebra |
| File Path | src/visual-proofs/proofs/algebra/ThreeTermSquareProof.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/algebra/ThreeTermSquareProof.tsx (8 lines).
...
|---|---|---|---|
| Screen-reader labels and diagram descriptions are not evident. | src/visual-proofs/proofs/algebra/ThreeTermSquareProof.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add aria labels, roles, and text summaries for diagrams and live values. |
| No adjacent automated test found. | src/visual-proofs/proofs/algebra/ThreeTermSquareProof.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Three Term Square Proof before you move the control?
