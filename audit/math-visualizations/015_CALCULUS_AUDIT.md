# Audit Report - Calculus

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Calculus |
| Concept Area | route page |
| File Path | src/pages/Calculus.tsx |
| Route / Page | /calculus |
...
- Source file was inspected: src/pages/Calculus.tsx (66 lines).
...
|---|---|---|---|
| Formula edge cases are not clearly guarded in source. | src/pages/Calculus.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add explicit guards and student-facing messages for zero, invalid, and out-of-domain states. |
| Pointer interaction appears to lack keyboard equivalent. | src/pages/Calculus.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/pages/Calculus.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Calculus before you move the control?
