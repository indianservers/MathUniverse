# Audit Report - Coordinate Proof Template

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Coordinate Proof Template |
| Concept Area | coordinate geometry |
| File Path | src/visual-proofs/proofs/coordinate-geometry/CoordinateProofTemplate.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/coordinate-geometry/CoordinateProofTemplate.tsx (407 lines).
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/visual-proofs/proofs/coordinate-geometry/CoordinateProofTemplate.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/visual-proofs/proofs/coordinate-geometry/CoordinateProofTemplate.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Coordinate Proof Template before you move the control?
