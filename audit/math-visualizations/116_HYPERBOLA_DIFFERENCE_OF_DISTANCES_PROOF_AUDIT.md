# Audit Report - Hyperbola Difference Of Distances Proof

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Hyperbola Difference Of Distances Proof |
| Concept Area | conic sections |
| File Path | src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx (8 lines).
...
- src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx
...
|---|---|---|---|
| Formula edge cases are not clearly guarded in source. | src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add explicit guards and student-facing messages for zero, invalid, and out-of-domain states. |
| Screen-reader labels and diagram descriptions are not evident. | src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add aria labels, roles, and text summaries for diagrams and live values. |
| No adjacent automated test found. | src/visual-proofs/proofs/conic-sections/HyperbolaDifferenceOfDistancesProof.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Hyperbola Difference Of Distances Proof before you move the control?
