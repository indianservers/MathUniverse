# Audit Report - Calculus Concept Atlas

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Calculus Concept Atlas |
| Concept Area | calculus |
| File Path | src/visualizations/calculus/CalculusConceptAtlas.tsx |
...
- Source file was inspected: src/visualizations/calculus/CalculusConceptAtlas.tsx (142 lines).
...
- src/visualizations/calculus/CalculusConceptAtlas.tsx
...
|---|---|---|---|
| Formula edge cases are not clearly guarded in source. | src/visualizations/calculus/CalculusConceptAtlas.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add explicit guards and student-facing messages for zero, invalid, and out-of-domain states. |
| Pointer interaction appears to lack keyboard equivalent. | src/visualizations/calculus/CalculusConceptAtlas.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/visualizations/calculus/CalculusConceptAtlas.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Calculus Concept Atlas before you move the control?
