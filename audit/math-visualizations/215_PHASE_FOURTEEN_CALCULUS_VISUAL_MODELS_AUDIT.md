# Audit Report - Phase Fourteen Calculus Visual Models

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Phase Fourteen Calculus Visual Models |
| Concept Area | phase fourteen |
| File Path | src/visual-proofs/proofs/phase-fourteen/PhaseFourteenCalculusVisualModels.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/phase-fourteen/PhaseFourteenCalculusVisualModels.tsx (379 lines).
...
- src/visual-proofs/proofs/phase-fourteen/PhaseFourteenCalculusVisualModels.tsx
...
|---|---|---|---|
| No adjacent automated test found. | src/visual-proofs/proofs/phase-fourteen/PhaseFourteenCalculusVisualModels.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Phase Fourteen Calculus Visual Models before you move the control?
