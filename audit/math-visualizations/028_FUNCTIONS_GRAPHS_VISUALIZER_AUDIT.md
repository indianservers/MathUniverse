# Audit Report - Functions Graphs Visualizer

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Functions Graphs Visualizer |
| Concept Area | route page |
| File Path | src/pages/FunctionsGraphsVisualizer.tsx |
| Route / Page | /math/functions-graphs |
...
- Source file was inspected: src/pages/FunctionsGraphsVisualizer.tsx (324 lines).
...
- src/pages/FunctionsGraphsVisualizer.tsx
...
|---|---|---|---|
| No adjacent automated test found. | src/pages/FunctionsGraphsVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Functions Graphs Visualizer before you move the control?
