# Audit Report - Quadratic Equation Visualizer

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Quadratic Equation Visualizer |
| Concept Area | algebra |
| File Path | src/visualizations/algebra/QuadraticEquationVisualizer.tsx |
...
- Source file was inspected: src/visualizations/algebra/QuadraticEquationVisualizer.tsx (177 lines).
...
- src/visualizations/algebra/QuadraticEquationVisualizer.tsx
...
|---|---|---|---|
| Formula edge cases are not clearly guarded in source. | src/visualizations/algebra/QuadraticEquationVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add explicit guards and student-facing messages for zero, invalid, and out-of-domain states. |
| No adjacent automated test found. | src/visualizations/algebra/QuadraticEquationVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Quadratic Equation Visualizer before you move the control?
