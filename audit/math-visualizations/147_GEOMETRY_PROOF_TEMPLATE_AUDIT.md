# Audit Report - Geometry Proof Template

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Geometry Proof Template |
| Concept Area | geometry |
| File Path | src/visual-proofs/proofs/geometry/GeometryProofTemplate.tsx |
...
- Source file was inspected: src/visual-proofs/proofs/geometry/GeometryProofTemplate.tsx (1296 lines).
...
|---|---|---|---|
| No adjacent automated test found. | src/visual-proofs/proofs/geometry/GeometryProofTemplate.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Geometry Proof Template before you move the control?
