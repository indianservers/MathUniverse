# Audit Report - Calculus Fundamentals Problems

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Calculus Fundamentals Problems |
| Concept Area | calculus |
| File Path | src/visualizations/calculus/CalculusFundamentalsProblems.tsx |
...
Calculus Fundamentals Problems is represented by SVG, sliders, drag/pan/zoom, formula logic/text. This is audited as a direct visualization component. Not suitable for Grade 6 without guided teacher support. It appears usable as part of the app, but should still be tested with edge-case values and classroom-sized screens.
...
- Source file was inspected: src/visualizations/calculus/CalculusFundamentalsProblems.tsx (375 lines).
...
- src/visualizations/calculus/CalculusFundamentalsProblems.tsx
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/visualizations/calculus/CalculusFundamentalsProblems.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/visualizations/calculus/CalculusFundamentalsProblems.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Calculus Fundamentals Problems before you move the control?
