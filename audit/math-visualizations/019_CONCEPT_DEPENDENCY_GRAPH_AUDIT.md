# Audit Report - Concept Dependency Graph

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Concept Dependency Graph |
| Concept Area | route page |
| File Path | src/pages/ConceptDependencyGraph.tsx |
| Route / Page | /concept-graph |
...
- Source file was inspected: src/pages/ConceptDependencyGraph.tsx (44 lines).
...
- src/pages/ConceptDependencyGraph.tsx
...
|---|---|---|---|
| No adjacent automated test found. | src/pages/ConceptDependencyGraph.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Concept Dependency Graph before you move the control?
