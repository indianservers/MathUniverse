# Audit Report - Board Syllabus Visualizer

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Board Syllabus Visualizer |
| Concept Area | route page |
| File Path | src/pages/BoardSyllabusVisualizer.tsx |
| Route / Page | /syllabus-visual/:topicId |
...
- Source file was inspected: src/pages/BoardSyllabusVisualizer.tsx (1032 lines).
...
|---|---|---|---|
| No adjacent automated test found. | src/pages/BoardSyllabusVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
| Large component mixes concerns. | src/pages/BoardSyllabusVisualizer.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Extract math kernels, controls, rendering primitives, and copy/config into tested units. |
...
1. What do you think will change in Board Syllabus Visualizer before you move the control?
