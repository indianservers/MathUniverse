# Audit Report - Calculus Proof Configs

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Calculus Proof Configs |
| Concept Area | calculus |
| File Path | src/visual-proofs/proofs/calculus/calculusProofConfigs.ts |
...
- Source file was inspected: src/visual-proofs/proofs/calculus/calculusProofConfigs.ts (141 lines).
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/visual-proofs/proofs/calculus/calculusProofConfigs.ts | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/visual-proofs/proofs/calculus/calculusProofConfigs.ts | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
...
1. What do you think will change in Calculus Proof Configs before you move the control?
