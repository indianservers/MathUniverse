# Audit Report - NCERTConcept Page

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | NCERTConcept Page |
| Concept Area | route page |
| File Path | src/pages/NCERTConceptPage.tsx |
| Route / Page | /ncert/:conceptId |
...
- Source file was inspected: src/pages/NCERTConceptPage.tsx (972 lines).
...
|---|---|---|---|
| Pointer interaction appears to lack keyboard equivalent. | src/pages/NCERTConceptPage.tsx | High impact on correctness, learning, accessibility, or maintenance. | Add keyboard controls, numeric inputs, or stepper buttons mirroring drag behavior. |
| No adjacent automated test found. | src/pages/NCERTConceptPage.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Add math-kernel tests and a render smoke test for default and edge states. |
| Large component mixes concerns. | src/pages/NCERTConceptPage.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Extract math kernels, controls, rendering primitives, and copy/config into tested units. |
...
1. What do you think will change in NCERTConcept Page before you move the control?
