# Audit Report - Trig Graph Studio

## 1. Basic Information

| Field | Details |
|---|---|
| Visualization Name | Trig Graph Studio |
| Concept Area | trigonometry |
| File Path | src/visualizations/trigonometry/TrigGraphStudio.tsx |
...
- Source file was inspected: src/visualizations/trigonometry/TrigGraphStudio.tsx (749 lines).
...
|---|---|---|---|
| Large component mixes concerns. | src/visualizations/trigonometry/TrigGraphStudio.tsx | Medium impact on correctness, learning, accessibility, or maintenance. | Extract math kernels, controls, rendering primitives, and copy/config into tested units. |
...
1. What do you think will change in Trig Graph Studio before you move the control?
