...
RESTORED_MOCKUPS = {
    ...
    261: "None in the required target structure. The dedicated finite segment AB model, independently draggable endpoints, snap and comparison modes, live length and midpoint observations, construction and definition panels, coordinate inputs, target endpoint practice validation, navigation, footer, and exact 1024x1536 portrait geometry were restored and visually checked.",
    262: "None in the required target structure. The dedicated fixed-length segment model, start-point and length controls, draggable direction handle, computed endpoint B, angle dial, invariant distance verification, worked example, coordinate rule, construction challenge, compass-and-straightedge sequence, navigation, footer, and exact 1024x1536 portrait geometry were restored and visually checked.",
