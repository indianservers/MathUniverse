...
## Lesson 274 / Mockup 0331 - Elevation and Depression

Reworked individually against the target mockup with a dedicated `draggable-observer-target-horizontal-sightline-elevation-depression-right-triangle-model`. Two physical observer and target handles drive the horizontal distance, vertical height, line-of-sight hypotenuse, sight angle, tangent ratio, elevation/depression orientation, and all diagram annotations. The model maintains the Pythagorean identity and `tan(theta) = opposite / adjacent` after every direct manipulation.

The five lesson-view controls, reset, share, workspace focus, elevation/depression tabs, angle/height/distance sliders and numeric fields, both SVG handles, numerical practice grading, solution collapse, and adjacent navigation are functional. Editing angle reconstructs height from the current adjacent distance; editing height or distance reconstructs the complementary dimension from the current angle. The reference practice card states `62.60 m`, but its own equations for 32 degrees, 48 degrees, and a 50 m approach solve to `71.435666 m`; the interactive lesson uses and grades the mathematically consistent `71.44 m` result.

Final 1023x1537 browser validation verifies the initial 45-degree, 90-by-90 construction and 127.279221 m hypotenuse; physically drags the target and observer separately while rechecking both identities; switches to depression and back; reconstructs a 30-degree triangle; independently changes height to 100 m and distance to 200 m; switches lesson views; rejects an incorrect practice answer, accepts 71.44 m, collapses and reopens the solution, and resets the complete lesson. The screenshot loop matches the target stack exactly: header y=104-205, tabs y=205-250, learning flow y=264-375, lab y=386-910, learning cards y=921-1167, practice y=1178-1340, and navigation y=1351-1403, inside an exact 1023x1537 document. It reports no horizontal overflow and zero console messages.
