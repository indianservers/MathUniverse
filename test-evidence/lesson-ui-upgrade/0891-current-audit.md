...
- Captured desktop evidence: `artifacts/studio-control-audit/0891-current.png`.
- One-by-one browser acceptance: opened the real route, edited a probability slider, ran the simulation, and verified the live sample/average state updated.
