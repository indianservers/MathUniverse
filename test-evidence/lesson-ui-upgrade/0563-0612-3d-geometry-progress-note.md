...
| 0597   |                    412 AR Placement | `ARPlacementTargetLesson412`        | Generated project-local photorealistic room/tabletop background with a live detected-plane grid and transparent React Three Fiber cube; direct Move/Rotate/Scale gesture model, placement and recentering, anchor lock, occlusion, plane-grid toggle, reset/share, guided tracking states, live real-world scale/anchor/surface/lighting/safety diagnostics, generated measurement diagram, target cycling, and genuinely graded ±2% metric-scale challenge | Exact 862 x 1825 target viewport plus 390 x 844 mobile rendering; nonblank desktop/mobile WebGL canvases; target-aligned 184 px sidebar and hero/tabs/simulator/tools/status/challenge/notes/tags/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0598   |              413 Surface z=f(x,y) | `SurfaceFunctionTargetLesson413`    | Generated triangulated React Three Fiber height mesh with live vertex colors and pointer intersection; Plane/Paraboloid/Saddle/Ripple evaluators, editable domain and coefficients, computed range, generic marching-contour extraction, synchronized x/y traces, gradient and tangent-plane derivation, orbit/zoom/pan, equation formatting, color modes, clipboard share/reset, and live genuinely graded saddle classification | Exact 1027 x 1531 target viewport plus 390 x 844 mobile rendering; nonblank desktop/mobile WebGL canvases; target-aligned 217 px sidebar and hero/tabs/surface/domain/plots/analysis/challenge/tip coordinates; no overflow or application console errors | Complete |
| 0599   |                 414 Implicit Surfaces | `ImplicitSurfacesTargetLesson414` | Dedicated React Three Fiber level-set lab with five actual preset geometries, equation-specific evaluators, editable iso value, resolution and six domain bounds, three independent movable slice planes, clipping/plot toggles, direct surface-point sampling, live F-c inside/outside classification, real orbit/zoom/pan, camera-aware reset, clipboard share, explanatory comparison, and interactive hyperboloid challenge | Exact 1024 x 1536 target viewport plus 390 x 844 mobile rendering; nonblank 465 x 520 WebGL canvas; target-aligned 205 px sidebar and hero/tabs/spanning-controls/canvas/slices/analysis/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0600   |              415 Parametric Surfaces | `ParametricSurfacesTargetLesson415` | Generated two-parameter React Three Fiber paraboloid from r(u,v)=(u cos v,u sin v,0.35u²), editable u/v domains that rebuild the mesh, direct surface picking with synchronized parameter/Cartesian coordinates, movable cross-section with computed radius, solid and wireframe modes, orbit/pan/zoom tools, camera reset, exact worked evaluation, parameter-sweep explanation, and genuinely graded quarter-slice challenge that changes the rendered v-domain | Exact 1171 x 1343 target viewport plus 390 x 844 mobile rendering; nonblank 559 x 440 WebGL canvas; target-aligned 235 px sidebar and hero/tabs/scene/controls/evaluation/pattern/challenge/navigation coordinates; no overflow or application console errors | Complete |
| 0601   |                    416 Space Curves | `SpaceCurvesTargetLesson416` | Generated React Three Fiber tube helix from r(t)=(cos t,sin t,t/4), live selected point and tangent arrow, synchronized numeric/range parameter control and x/y/z component plots, exact derivative/speed/curvature/radius/pitch calculations, removable grid and axes, orbit/zoom and camera reset, five working tabs, general helix rule, correct curvature derivation, and interactive second-helix challenge solution | Exact 970 x 1622 target viewport plus 390 x 844 mobile rendering; nonblank 399 x 524 WebGL canvas; target-aligned 208 px sidebar and hero/tabs/helix/rail/metrics/pattern/rule/worked/challenge/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0602   |                417 Quadric Surfaces | `QuadricSurfacesTargetLesson417` | Dedicated completing-square coefficient model with editable A-G numeric/range controls, five real generated React Three Fiber quadric families, computed center/completed constant/sign pattern/classification/boundedness, synchronized coordinate-plane traces, persistent grid and labeled axes, planes/traces/grid layers, orbit/zoom and camera reset, five working tabs, classification rule table, worked ellipsoid sketch, misconception comparison, and genuinely graded hyperboloid challenge | Exact 997 x 1577 target viewport plus 390 x 844 mobile rendering; nonblank 476 x 420 WebGL canvas; target-aligned 201 px sidebar and hero/tabs/classifier/canvas/coefficient/traces/rules/worked/challenge/navigation coordinates; no overflow or application console errors | Complete |
| 0603   |         418 Cylindrical Coordinates | `CylindricalCoordinatesTargetLesson418` | Dedicated cylindrical point model with bidirectional cylindrical/Cartesian conversion, directly draggable P at fixed height, synchronized r/θ/z sliders and x/y/z outputs, live translucent radius cylinder, radial/height/projection segments and angle arc, orbit/zoom and camera reset, five working tabs, conversion mode switch, exact rule/worked derivation, sine/cosine projection diagram, plotted Cartesian challenge point, and genuinely graded conversion inputs | Exact 986 x 1595 target viewport plus 390 x 844 mobile rendering; nonblank 450 x 448 WebGL canvas; target-aligned 202 px sidebar and hero/tabs/lab/canvas/controls/steps/rules/challenge/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0604   |           419 Spherical Coordinates | `SphericalCoordinatesTargetLesson419` | Dedicated spherical point model with direct P dragging over the sphere, synchronized ρ/θ/φ sliders and Cartesian outputs, live translucent sphere/radial/projection geometry, orbit/zoom and camera reset, five working tabs, azimuth/polar/radial guides, convention and misconception panels, exact forward/inverse rules, worked conversion, hint, and genuinely graded three-coordinate challenge | Exact 1178 x 1335 target viewport plus 390 x 844 mobile rendering; nonblank 569 x 456 WebGL canvas; target-aligned 236 px sidebar and hero/tabs/sphere/controls/guides/rules/challenge/navigation coordinates; no overflow or application console errors | Complete |
| 0605   |                 420 Contour Curves | `ContourCurvesTargetLesson420` | Dedicated sampled z=sin(x)cos(y) React Three Fiber surface with synchronized movable level plane, real marching-squares contour extraction rendered in both 3D and a linked 2D level map, live level/min/max/contour classification, orbit/zoom and camera reset, five working tabs, zero-level line sketch, definition/misconception panels, level-set practice grading, and quick-check state | Exact 959 x 1640 target viewport plus 390 x 844 mobile rendering; nonblank 378 x 427 WebGL canvas; target-aligned 206 px sidebar and hero/tabs/linked-surface/map/metrics/rules/practice/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0606   |                  421 Level Surfaces | `LevelSurfacesTargetLesson421` | Dedicated scalar field F=x²+y²+z² with c-driven concentric React Three Fiber spheres, exact radius/area/volume calculations, five level presets, solid/wire/points/dotted styles, sampling control, axes/sample/cross-section/numeric-label layers, orbit/zoom and camera reset, five working tabs, computed comparison table, rule/misconception panels, worked c=5 calculation, and real c=3 challenge application | Exact 983 x 1600 target viewport plus 390 x 844 mobile rendering; nonblank 508 x 410 WebGL canvas; target-aligned 199 px sidebar and hero/tabs/scalar-field/canvas/controls/metrics/rules/challenge/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0607   |             422 Partial Derivatives | `PartialDerivativesTargetLesson422` | Dedicated z=x²+y² radial paraboloid with directly draggable P, synchronized x/y sliders, exact z/∂z∂x/∂z∂y calculations, live x- and y-direction 3D slices, projection and tangent geometry, two computed 2D slice/tangent charts, orbit/zoom and camera reset, five working tabs, directional interpretation, limit definitions, misconception/worked panels, hint, and genuinely graded two-part derivative challenge | Exact 1003 x 1568 target viewport plus 390 x 844 mobile rendering; nonblank 466 x 453 WebGL canvas; target-aligned 210 px sidebar and hero/tabs/surface/controls/cross-sections/rules/challenge/navigation/footer coordinates; no overflow or application console errors | Complete |
| 0608   |                  423 Gradient Vector | `GradientVectorTargetLesson423` | Dedicated f=x²-xy+y² height field over the exact f≤6 elliptical domain with directly draggable P, synchronized x/y controls, exact height/gradient/magnitude/unit-vector/tangent/dot calculations, live 3D gradient arrow and linked 2D contour/tangent map, opacity and four tool modes, orbit/zoom/reset, five working tabs, orthogonality/rule/misconception panels, and genuinely graded five-field x²-y² challenge with hint | Exact 972 x 1619 target viewport plus 390 x 844 mobile rendering; nonblank 423 x 323 WebGL canvas; target-aligned 198 px sidebar and hero/tabs/steps/surface/contour/controls/readouts/rules/challenge/navigation coordinates; no overflow or application console errors | Complete |
| 0609   |                   424 Tangent Plane | `TangentPlaneTargetLesson424` | Dedicated f=sin(x)cos(y) surface with directly draggable contact point P, synchronized a/b sliders, exact f/fₓ/fᵧ calculations, generated tangent-plane geometry, sampled local approximation error, full/neighborhood zoom modes, orbit/reset, five working tabs, worked x²y+sin(y) derivation, shifted-coordinate misconception comparison, and genuinely graded five-field e^(xy) linearization challenge with hint and solution | Exact 956 x 1645 target viewport plus full-width 390 px mobile rendering; nonblank 430 x 397 WebGL canvas with surface wire mesh, live tangent plane and labeled axes; target-aligned 191 px sidebar and hero/tabs/lab/canvas/worked/rules/challenge/navigation coordinates; no overflow or application console errors | Complete |
| 0610   |                    425 Normal Vector | `NormalVectorTargetLesson425` | Dedicated point-and-spanning-vectors model with directly draggable P, editable P/u/v coordinates, generated plane, exact n=u×v normal and two live orthogonality dot products, three vector arrows, orbit/reset/recompute, five working tabs, rule and misconception panels, corrected worked determinant, and genuinely graded challenge accepting every nonzero scalar multiple of the computed normal | Exact 959 x 1640 target viewport plus full-width 390 px mobile rendering; nonblank 488 x 440 WebGL canvas; target-aligned 194 px sidebar and hero/tabs/lab/canvas/checks/rules/challenge/navigation coordinates; no overflow or application console errors. Mockup arithmetic errors are corrected: displayed u and v yield n=(5,0,-5), not (3,0,-5), and challenge n=(1,-1,2), not (2,-1,2). | Complete |
| 0611   |                 426 Double Integrals | `DoubleIntegralsTargetLesson426` | Dedicated linked region/integration model with four editable rectangular bounds, three real surface evaluators, exact analytic integral/area/min/max/average calculations, generated 2D SVG region and Three.js surface/Riemann columns, Nx/Ny partition controls, column/mesh layers, both integration orders, orbit, five working tabs, Fubini and misconception panels, worked iterated integrals, and genuine wrong/correct challenge grading with hint | Exact 975 x 1612 target viewport plus full-width 390 px mobile rendering; nonblank 318 x 385 WebGL canvas; target-aligned 200 px sidebar and hero/tabs/lab/linked plots/metrics/pattern/rules/challenge/navigation coordinates; no overflow or application console errors. Mockup challenge key is corrected from 72 to the exact integral 84. | Complete |
| 0612   | 427 Multivariable Optimisation | `MultivariableOptimisationTargetLesson427` | Dedicated quadratic-form model with directly draggable P, exact f/gradient/magnitude/Hessian/eigenvalue calculations, generated Three.js surface and mathematically correct linked contour/gradient maps, stationary-line and degenerate-minimum classification, optional constraint curve, orbit/reset, completion state, five working tabs, Hessian decision table, corrected worked analysis, and genuine two-field challenge grading with solution | Exact 1030 x 1527 target viewport plus full-width 390 px mobile rendering; nonblank 340 x 310 WebGL canvas; target-aligned 214 px sidebar and hero/tabs/lab/linked plots/readouts/pattern/rules/challenge/navigation coordinates; no overlap, horizontal overflow, or application console errors. Mockup is corrected: f=(x-y)² has a global minimum trough on x=y, not saddle points, and its contours are parallel lines. | Complete |

Completed in this family: **50 / 50**. Pending in this family: **0 / 50**.
...
## Lesson 412 validation

- Reference: `0597-reference.png`
- Current capture: `0597-desktop.png`
- Mobile capture: `0597-mobile.png`
- Canvas-only capture: `0597-canvas.png`
- Generated room asset: `public/assets/lesson-412/ar-study-room.png`
- Machine-readable interaction and layout audit: `0597-validation.json`
- The capture harness verifies the initial anchored one-metre cube, detected horizontal plane, locked anchor, occlusion and scale state; re-places the cube, unlocks it, physically drags to change its x/z pose, rotates it through a separate drag mode, scales it beyond one metre and rejects the challenge, re-locks the anchor, disables occlusion and the detected grid, recenters the object, resets to the exact one-metre pose and accepts the ±2% challenge, cycles to a 0.5 m target, exercises clipboard share and final reset; confirms the exact 862 x 1825 target viewport and every section endpoint, a nonblank generated-room WebGL composition, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 413 validation

- Reference: `0598-reference.png`
- Current capture: `0598-desktop.png`
- Mobile capture: `0598-mobile.png`
- Canvas-only capture: `0598-canvas.png`
- Machine-readable interaction and layout audit: `0598-validation.json`
- The capture harness verifies the default z=x²−y² saddle, coefficients 1/−1/0, range [−9,9], point (0,0,0), zero gradient and correct saddle classification; physically orbits and proves rendered pixels change, replaces the actual mesh with Plane/Paraboloid/Ripple/Saddle evaluators, edits coefficients to 2/−2/1 and proves range [−17,19], extends x to 4 and proves dependent range changes, selects a contour point and proves point/gradient updates, changes both trace slices, rejects a downward-x/upward-y surface and accepts the corrected saddle, then exercises clipboard share and reset; confirms the exact 1027 x 1531 target viewport and every section endpoint, a nonblank WebGL surface, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 414 validation

- Reference: `0599-reference.png`
- Current capture: `0599-desktop.png`
- Mobile capture: `0599-mobile.png`
- Canvas-only capture: `0599-canvas.png`
- Machine-readable interaction and layout audit: `0599-validation.json`
- The capture harness verifies the default sphere level set x²+y²+z²=9 and the displayed point's F=10.5025, F-c=1.5025 Outside classification; physically orbits and proves rendered pixels change; replaces the actual scene with Ellipsoid, Hyperboloid, Torus, Gyroid, and Sphere models while synchronizing each evaluator and iso value; changes c to 4 and proves the dependent difference becomes 6.5025; moves the xy slice to 1.5, disables the xz slice, expands x max to 7, disables clipping, activates the hyperboloid challenge, and resets both lesson state and camera; confirms the exact 1024 x 1536 document and target row endpoints, a nonblank 465 x 520 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 415 validation

- Reference: `0600-reference.png`
- Current capture: `0600-desktop.png`
- Mobile capture: `0600-mobile.png`
- Canvas-only capture: `0600-canvas.png`
- Machine-readable interaction and layout audit: `0600-validation.json`
- The capture harness verifies the target r(u,v)=(u cos v,u sin v,0.35u²), selected (1.6,1.2), computed point (0.5798,1.4913,0.896), full u/v domains, z=0.9 plane and radius 1.6036; physically orbits and proves rendered pixels change while direct surface picking updates u/v and x/y/z; replaces the solid with a real wireframe, moves the plane to z=1.4 and proves radius 2, narrows u max to approximately 2.04 and rebuilds the mesh, exercises Pan and Zoom, rejects the sphere answer, accepts the quarter-slice answer and proves v becomes [-π/4,π/4], then resets lesson and camera; confirms the exact 1171 x 1343 document and target section endpoints, a nonblank 559 x 440 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 416 validation

- Reference: `0601-reference.png`
- Current capture: `0601-desktop.png`
- Mobile capture: `0601-mobile.png`
- Canvas-only capture: `0601-canvas.png`
- Machine-readable interaction and layout audit: `0601-validation.json`
- The capture harness verifies the target helix r(t)=(cos t,sin t,t/4), t=2.5 point (-0.8011,0.5985,0.625), tangent, mathematically consistent speed √17/4≈1.0308, curvature 16/17≈0.9412, radius 17/16 and pitch π/2; physically orbits and proves rendered pixels change; edits t to π and proves point (-1,0,π/4) across the 3D point and all component plots; disables grid and axes, switches to Formula, reveals and verifies the radius-2/pitch-2π/speed-√5/curvature-2/5 challenge solution, resets the camera, and reloads to the exact initial state before evidence; confirms the exact 970 x 1622 document and target section endpoints, a nonblank 399 x 524 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 417 validation

- Reference: `0602-reference.png`
- Current capture: `0602-desktop.png`
- Mobile capture: `0602-mobile.png`
- Canvas-only capture: `0602-canvas.png`
- Machine-readable interaction and layout audit: `0602-validation.json`
- The capture harness verifies the default ellipsoid, center (0,0,0), completed constant -1 and bounded state; physically orbits and proves rendered pixels change; replaces the rendered geometry with one-sheet and two-sheet hyperboloids, an elliptic cone, an elliptic paraboloid, and the ellipsoid preset while checking every computed classification; edits D=2 and proves the center becomes (-1,0,0), changes C=-1 and proves the hyperboloid branch, exercises grid and plane layers, switches to Formula, records incorrect and correct challenge grading, and reloads to the exact initial state before evidence; confirms the exact 997 x 1577 document and target section endpoints, a nonblank 476 x 420 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 418 validation

- Reference: `0603-reference.png`
- Current capture: `0603-desktop.png`
- Mobile capture: `0603-mobile.png`
- Canvas-only capture: `0603-canvas.png`
- Machine-readable interaction and layout audit: `0603-validation.json`
- The capture harness verifies the target cylindrical point (3.61,40°,2) and Cartesian conversion (2.77,2.32,2); physically orbits and proves rendered pixels change, then physically drags P and proves the model changes to approximately (2.39,3.13°,2) with Cartesian output (2.38,0.13,2); edits the sliders to (5,90°,-2) and proves (0,5,-2), switches to Cartesian conversion mode and Formula, records incorrect and correct grades for converting (-3,4,2), plots that point and proves (5,126.87°,2), then reloads to the exact initial state before evidence; confirms the exact 986 x 1595 document and target section endpoints, a nonblank 450 x 448 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 419 validation

- Reference: `0604-reference.png`
- Current capture: `0604-desktop.png`
- Mobile capture: `0604-mobile.png`
- Canvas-only capture: `0604-canvas.png`
- Machine-readable interaction and layout audit: `0604-validation.json`
- The capture harness verifies the target spherical point (3,45°,60°) and Cartesian conversion (1.84,1.84,1.5); physically orbits and proves rendered pixels change, then physically drags P over the sphere and proves θ/φ change to approximately 28.79°/54.3° with synchronized Cartesian output (2.14,1.17,1.75); edits the sliders to (4,30°,60°) and proves (3,1.73,2), switches to Formula, reveals the hint, records incorrect and correct grades for the ρ=5, θ=210°, φ=45° challenge, and reloads to the exact initial state; confirms the exact 1178 x 1335 document and target section endpoints, a nonblank 569 x 456 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 420 validation

- Reference: `0605-reference.png`
- Current capture: `0605-desktop.png`
- Mobile capture: `0605-mobile.png`
- Canvas-only capture: `0605-canvas.png`
- Machine-readable interaction and layout audit: `0605-validation.json`
- The capture harness verifies the target k=0.30 slice, 172 generated marching-squares segments, and closed-curve classification; physically orbits and proves rendered pixels change; moves the linked plane through k=0.60, k=0, k=1, and k=-0.50 and proves regenerated contours plus intersecting-line/point/closed classifications; switches to Formula, records incorrect and correct level-set choices, applies the k=0.60 challenge to the live model, exercises incorrect/correct quick-check states, and reloads to the exact initial state; confirms the exact 959 x 1640 document and target section endpoints, a nonblank 378 x 427 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 421 validation

- Reference: `0606-reference.png`
- Current capture: `0606-desktop.png`
- Mobile capture: `0606-mobile.png`
- Canvas-only capture: `0606-canvas.png`
- Machine-readable interaction and layout audit: `0606-validation.json`
- The capture harness verifies c=2, radius √2≈1.414, mathematically exact area 8π≈25.133 and volume 4π(√2)³/3≈11.848; physically orbits and proves rendered pixels change; changes to c=4 and proves radius 2, area 16π and volume 32π/3; exercises solid/wire/points/dotted styles, all four display layers, sampling Off, the c=0.50 preset, and Formula; applies the c=3 challenge and proves radius √3≈1.732, area 12π≈37.699 and volume 4π√3≈21.766, then checks local and page resets; confirms the exact 983 x 1600 document and target section endpoints, a nonblank 508 x 410 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 422 validation

- Reference: `0607-reference.png`
- Current capture: `0607-desktop.png`
- Mobile capture: `0607-mobile.png`
- Canvas-only capture: `0607-canvas.png`
- Machine-readable interaction and layout audit: `0607-validation.json`
- The capture harness verifies P=(1.5,-1), z=3.25, ∂z/∂x=3 and ∂z/∂y=-2; physically orbits and proves rendered pixels change, then physically drags P to approximately (1.56,-0.9) and proves z≈3.24 with slopes 3.12 and -1.8; edits P to (2,1) and proves z=5/slopes 4 and 2, then to (-2.5,0.5) and proves z=6.5/slopes -5 and 1; switches to Formula, records incorrect and correct grades for the two-part x²+xy+y² challenge, reveals the derivative hint, and reloads to the exact initial state; confirms the exact 1003 x 1568 document and target section endpoints, a nonblank 466 x 453 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.

## Lesson 423 validation

- Reference: `0608-reference.png`
- Current capture: `0608-desktop.png`
- Mobile capture: `0608-mobile.png`
- Canvas-only capture: `0608-canvas.png`
- Machine-readable interaction and layout audit: `0608-validation.json`

## Lesson 424 validation

- Reference: `0609-reference.png`
- Current capture: `0609-desktop.png`
- Mobile capture: `0609-mobile.png`
- Canvas-only capture: `0609-canvas.png`
- Machine-readable interaction and layout audit: `0609-validation.json`
- The capture harness verifies the default P=(0.6,0.3), f=sin(0.6)cos(0.3)≈0.5394, fₓ≈0.7885, and fᵧ≈-0.1669; physically drags P and proves that coordinates, height, derivatives, tangent plane, and sampled error all update; changes the controls near (1,0), proves f≈sin(1), fₓ≈cos(1), and fᵧ≈0, then proves that neighborhood zoom reduces maximum sampled linearization error from 0.1140 to 0.0200; exercises orbit, camera reset, Formula tab, wrong/correct challenge grading, hint, solution, and shell reset; confirms exact 956 x 1645 dimensions, a nonblank 430 x 397 WebGL canvas, an overflow-free full-width 390 px mobile rendering, and absence of application console errors.

## Lesson 425 validation

- Reference: `0610-reference.png`
- Current capture: `0610-desktop.png`
- Mobile capture: `0610-mobile.png`
- Canvas-only capture: `0610-canvas.png`
- Machine-readable interaction and layout audit: `0610-validation.json`
- The capture harness verifies P=(1,2,1), u=(1,2,1), v=(2,-1,2), their mathematically correct cross product n=(5,0,-5), and both n·u=0 and n·v=0; physically drags P and proves the point state changes, then moves P to (-1,1.5,2), changes the basis to u=(1,0,0), v=(0,1,0), and proves n=(0,0,1) with both dot products still zero; exercises orbit, camera reset, recompute, Formula tab, wrong challenge grading, valid scalar-multiple grading with (2,-2,4), and shell reset; confirms exact 959 x 1640 dimensions, a nonblank 488 x 440 WebGL canvas, an overflow-free full-width 390 px mobile rendering, and absence of application console errors.

## Lesson 426 validation

- Reference: `0611-reference.png`
- Current capture: `0611-desktop.png`
- Mobile capture: `0611-mobile.png`
- Canvas-only capture: `0611-canvas.png`
- Machine-readable interaction and layout audit: `0611-validation.json`
- The capture harness verifies the default region [0,3]×[0,2], z=x+y+1, area 6, min 1, max 6, average 3.5, and exact volume 21; switches to z=x²+y² over [0,2]×[0,1] and proves area 2, min 0, max 5, average 5/3, and volume 10/3; changes Nx/Ny to 6/5, disables columns, enables the generated surface mesh, switches integration order, and verifies linked state; exercises orbit pixels, Formula tab, wrong answer 72, correct answer 84, hint, and shell reset; confirms exact 975 x 1612 dimensions, a nonblank 318 x 385 WebGL canvas, an overflow-free full-width 390 px mobile rendering, and absence of application console errors.

## Lesson 427 validation

- Reference: `0612-reference.png`
- Current capture: `0612-desktop.png`
- Mobile capture: `0612-mobile.png`
- Canvas-only capture: `0612-canvas.png`
- Machine-readable interaction and layout audit: `0612-validation.json`
- The capture harness verifies the default P=(1.2,-0.8), f=(x-y)²=4, ∇f=(4,-4), |∇f|≈5.657, Hessian determinant 0, and non-stationary classification; physically drags P and proves both coordinates change, then moves to (1,1) and proves f=0, ∇f=(0,0), and the degenerate global-minimum trough; enables the generated circular constraint, exercises orbit, reset, Formula tab, wrong saddle/origin grading, correct x=2y minimum-trough grading for (x-2y)², solution disclosure, completion state, and shell reset; confirms exact 1030 x 1527 dimensions, a nonblank 340 x 310 WebGL canvas, an overflow-free full-width 390 px mobile rendering, no overlapping workspace rows, and absence of application console errors.
- The capture harness verifies P=(1,0.5), mathematically consistent f=0.75, ∇f=(1.5,0), magnitude 1.5, unit direction (1,0), and zero tangent dot product; physically orbits and proves rendered pixels change, then physically drags P to approximately (1.051,0.677) and proves f≈0.851, ∇f≈(1.424,0.304), magnitude≈1.456, unit direction≈(0.978,0.209), and preserved orthogonality; edits P to (2,-1) and proves f=7, ∇f=(5,-4), magnitude √41 and zero dot product; exercises opacity, Pan/Target/Select tools, Formula, incorrect/correct five-field x²-y² challenge grades and hint, then reloads to the exact initial state; confirms the exact 972 x 1619 document and target section endpoints, a nonblank 423 x 323 WebGL canvas, an overflow-free nonblank 390 px mobile rendering, and absence of application console errors.
