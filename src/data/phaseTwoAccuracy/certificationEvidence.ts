...
export const phaseTwoCertificationEvidence: CertificationEvidence[] = [
  ...
  ...phaseTwoSystemContracts.map(
    (contract) =>
      ({
        contractId: contract.id,
        mathematical:
          contract.area === "curriculum" || contract.area === "certification"
            ? "partial"
            : "missing",
        content: "partial",
        assessment: contract.area === "practice" ? "partial" : "missing",
        accessibility: "partial",
        browser: "missing",
        reviewer: null,
        reviewedAt: null,
