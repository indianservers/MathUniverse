...
const authoredAdvancedSyllabusLabs: AdvancedSyllabusLab[] = [
  ...
  { id: "transportation-assignment-lab", title: "Transportation and Assignment Problem Lab", category: "Degree Mathematics", subcategory: "Operations Research", summary: "Compare supply-demand allocation costs with one-to-one assignment decisions in an operations-research workflow.", formula: "minimize total cost = sum c_ij x_ij subject to supply, demand, and assignment constraints", visual: "operations-research", sliderA: "Route cost weight", sliderB: "Assignment penalty", minA: 0.5, maxA: 5, stepA: 0.5, minB: 0.5, maxB: 5, stepB: 0.5, defaultA: 2.5, defaultB: 1.5, tasks: ["Change route cost weight.", "Change assignment penalty.", "Identify the lowest-cost allocation pattern."] },
