...
const scenarioSeeds = [
  ...
  scenario("engineering-linear-algebra", "eigen-stability-sweep", "Eigen stability sweep", "x_(k+1)=A*x_k", "spectral radius", 0.82, "", "/syllabus-lab/eigenvector-direction-visualizer", ["trace", "determinant", "basis vector"], ["matrix snapshot", "eigen table", "stability verdict"], [0.28, 0.46, 0.68, 0.82, 0.64, 0.52, 0.41, 0.33]),
