...
export const syllabusLevels: SyllabusLevel[] = [
  level("class-7", "Class 7 Mathematics", "NCERT bridge into integers, rational numbers, equations, geometry, symmetry, mensuration, and solid shapes.", "Foundation", [
    ...
    topic("Class 7", "Simple Equations", "Algebra", "available", "Balance beam interactive lab — solve ax + b = c step by step", "/ncert/class-7-simple-equations", ["ax+b=c", "x=(c-b)/a"], ["Equation", "Solution", "Inverse operation"]),
    ...
    topic("Class 7", "Algebraic Expressions", "Algebra", "available", "Expression substitution via identity tiles", "/ncert/class-8-algebraic-identities", ["terms", "like terms"], ["Variables", "Terms", "Substitution"]),
  ...
  level("class-8", "Class 8 Mathematics", "Foundation in numbers, algebra, geometry, mensuration, and data handling.", "Foundation", [
    ...
    topic("Class 8", "Linear Equations in One Variable", "Algebra", "available", "Balance beam interactive lab — solve ax + b = c step by step", "/ncert/class-7-simple-equations", ["ax + b = c"], ["Solving", "Inverse operations"]),
    topic("Class 8", "Understanding Quadrilaterals", "Geometry", "available", "Polygon angle and property explorer", "/geometry/quadrilaterals", ["sum of interior angles = (n-2)×180"], ["Parallelogram", "Rhombus", "Rectangle"]),
    ...
    topic("Class 8", "Algebraic Expressions and Identities", "Algebra", "available", "Area model for (a+b)² and other identities", "/ncert/class-8-algebraic-identities", ["(a+b)^2 = a^2+2ab+b^2"], ["Terms", "Identities"]),
    topic("Class 8", "Mensuration", "Geometry", "available", "2D and 3D measurement explorer", "/geometry/mensuration-3d", ["area", "volume"], ["Area", "Volume"]),
    ...
    topic("Class 8", "Direct and Inverse Proportions", "Algebra", "available", "Direct y=kx vs inverse y=k/x graph comparison", "/ncert/class-8-proportion", ["y = kx", "xy = k"], ["Graphs", "Ratios"]),
    topic("Class 8", "Factorisation", "Algebra", "available", "Identity tiles show common factor structure", "/ncert/class-8-algebraic-identities", ["ab+ac=a(b+c)"], ["Factors", "Common terms"]),
    topic("Class 8", "Introduction to Graphs", "Coordinate Geometry", "available", "Coordinate and line graph lab", "/geometry/coordinate-geometry", ["(x,y)", "y=mx+c"], ["Coordinates", "Line graph"]),
  ]),
  level("class-9", "Class 9 Mathematics", "Board foundation for polynomials, coordinate geometry, proofs, triangles, circles, and statistics.", "Foundation", [
    ...
    topic("Class 9", "Polynomials", "Algebra", "available", "Polynomial graph with roots and discriminant explorer", "/ncert/class-9-polynomials", ["p(x)", "remainder theorem"]),
    topic("Class 9", "Coordinate Geometry", "Coordinate Geometry", "available", "Coordinate plane, distance and midpoint lab", "/geometry/coordinate-geometry", ["(x,y)"]),
    topic("Class 9", "Linear Equations in Two Variables", "Algebra", "available", "Two-line intersection lab — graphical and algebraic solution", "/ncert/class-10-pair-linear", ["ax+by+c=0"], ["Graph method", "Unique/parallel/coincident"]),
    ...
    topic("Class 9", "Lines and Angles", "Geometry", "available", "Parallel lines and transversal angle explorer", "/geometry/parallel-lines", ["linear pair", "parallel lines"]),
    topic("Class 9", "Triangles", "Geometry", "available", "Triangle congruence and area explorer", "/geometry/triangles", ["A+B+C=180 deg"]),
    topic("Class 9", "Quadrilaterals", "Geometry", "available", "Quadrilateral properties with angle sum", "/geometry/quadrilaterals"),
    topic("Class 9", "Circles", "Geometry", "available", "Circle with sectors and tangent explorer", "/geometry/circles", ["C=2*pi*r", "A=pi*r^2"]),
    ...
    topic("Class 9", "Surface Areas and Volumes", "Geometry", "available", "3D mensuration explorer", "/geometry/surface-area-volume", ["SA", "V"]),
  ...
  level("class-10", "Class 10 Mathematics", "Board-level foundation for algebra, geometry, trigonometry, mensuration, statistics, and probability.", "Intermediate", [
    ...
    topic("Class 10", "Polynomials", "Algebra", "available", "Polynomial zero explorer — see how graph crossings relate to roots", "/ncert/class-10-polynomials", ["p(x)=x²+bx+c", "zeroes=roots"]),
    topic("Class 10", "Pair of Linear Equations in Two Variables", "Algebra", "available", "Two-line intersection lab — unique, parallel, or coincident", "/ncert/class-10-pair-linear", ["m1x+c1=m2x+c2"], ["Unique solution", "No solution", "Infinite solutions"]),
    topic("Class 10", "Quadratic Equations", "Algebra", "available", "Parabola with full a, b, c sliders — discriminant and roots", "/ncert/class-10-quadratic", ["ax^2+bx+c=0", "D=b^2-4ac"], ["Roots", "Discriminant", "Vertex"]),
    topic("Class 10", "Arithmetic Progressions", "Algebra", "available", "Arithmetic progression blocks and sum formula animation", "/ncert/class-10-arithmetic-progressions", ["a_n=a+(n-1)d", "S_n=n/2[2a+(n-1)d]"]),
    topic("Class 10", "Triangles", "Geometry", "available", "Triangle similarity and congruence explorer", "/geometry/triangles", ["SSS", "SAS", "AA"]),
    ...
    topic("Class 10", "Introduction to Trigonometry", "Trigonometry", "available", "Unit circle, sine, cosine and tangent explorer", "/trigonometry"),
    ...
    topic("Class 10", "Circles", "Geometry", "available", "Circle, sector, arc, tangent and chord explorer", "/geometry/circles", ["C=2πr", "A=πr²"]),
    topic("Class 10", "Areas Related to Circles", "Geometry", "available", "Sector and arc length visualizer", "/geometry/arcs-sectors", ["sector area=θ/360·πr²"]),
    topic("Class 10", "Surface Areas and Volumes", "Geometry", "available", "Surface area and volume lab for cylinders and spheres", "/geometry/surface-area-volume", ["V=πr²h", "SA=2πr(r+h)"]),
  ...
  level("class-11", "Class 11 Mathematics", "Advanced school mathematics connecting functions, trigonometry, analytic geometry, calculus, statistics, and probability.", "Advanced", [
    topic("Class 11", "Sets", "Advanced Mathematics", "available", "Venn diagram builder with union, intersection and difference", "/syllabus-lab/venn-diagram-builder"),
    topic("Class 11", "Relations and Functions", "Advanced Mathematics", "available", "Mapping diagram and function graph explorer", "/syllabus-lab/function-mapping-arrows"),
    ...
    topic("Class 11", "Linear Inequalities", "Algebra", "available", "Shaded solution region — number line and half-plane visualizer", "/ncert/class-11-linear-inequalities", ["ax+b>c", "half-plane"]),
    topic("Class 11", "Permutations and Combinations", "Probability", "available", "Arrangement tree and nCr/nPr comparison lab", "/ncert/class-11-permutations"),
    topic("Class 11", "Binomial Theorem", "Algebra", "available", "Pascal triangle and expansion builder", "/ncert/class-11-binomial"),
    topic("Class 11", "Sequences and Series", "Algebra", "available", "Partial sum visualizer for arithmetic progressions, geometric progressions, and series convergence", "/syllabus-lab/series-partial-sum", ["S_n", "convergence"]),
    topic("Class 11", "Straight Lines", "Coordinate Geometry", "available", "Line, slope, intercept and pair of lines lab", "/geometry/coordinate-geometry", ["m=(y2-y1)/(x2-x1)", "y=mx+c"]),
    topic("Class 11", "Conic Sections", "Geometry", "available", "Ellipse, parabola, hyperbola focus-directrix model", "/ncert/class-11-conics"),
    topic("Class 11", "Introduction to Three Dimensional Geometry", "Geometry", "available", "3D mensuration explorer with volume and surface area", "/geometry/mensuration-3d", ["3D coordinates", "distance formula"]),
  ...
  level("class-12", "Class 12 Mathematics", "Senior secondary mathematics focused on calculus, matrices, vectors, probability, and optimization.", "Advanced", [
    topic("Class 12", "Relations and Functions", "Advanced Mathematics", "available", "Function composition and inverse function visualizer", "/syllabus-lab/function-mapping-arrows"),
    topic("Class 12", "Inverse Trigonometric Functions", "Trigonometry", "available", "sin⁻¹, cos⁻¹, tan⁻¹ principal value graph with domain and range", "/ncert/class-12-inverse-trig", ["sin⁻¹", "cos⁻¹", "tan⁻¹"]),
    ...
    topic("Class 12", "Differential Equations", "Calculus", "available", "Slope field and solution curve visualizer", "/syllabus-lab/slope-field-generator"),
    topic("Class 12", "Vector Algebra", "Linear Algebra", "available", "Vector visualizer", "/linear-algebra"),
    topic("Class 12", "Three Dimensional Geometry", "Geometry", "available", "Surface area and volume explorer for cylinders, cones, and spheres", "/geometry/surface-area-volume", ["V=πr²h", "direction cosines"]),
    topic("Class 12", "Linear Programming", "Advanced Mathematics", "available", "Feasible region and corner point optimization", "/ncert/class-12-linear-programming"),
  ...
  level("degree", "Degree Mathematics", "Undergraduate mathematics mapped to available labs and future advanced modules.", "Advanced", [
    topic("Degree", "Foundations and Logic", "Advanced Mathematics", "available", "Truth table and logical connectives explorer", "/syllabus-lab/truth-table-generator"),
    topic("Degree", "Set Theory and Relations", "Advanced Mathematics", "available", "Venn diagrams and set operations visualizer", "/syllabus-lab/venn-diagram-builder"),
    topic("Degree", "Abstract Algebra", "Advanced Mathematics", "available", "Group Cayley table and modular clock explorer", "/syllabus-lab/cayley-table-generator"),
    ...
    topic("Degree", "Multivariable Calculus", "Calculus", "available", "3D surface, gradient, and double integral explorer", "/syllabus-lab/double-integral-region"),
    topic("Degree", "Real Analysis", "Advanced Mathematics", "available", "Sequence convergence and epsilon-neighbourhood visualizer", "/syllabus-lab/sequence-convergence"),
    topic("Degree", "Differential Equations", "Calculus", "available", "Slope field and Euler method visualizer", "/syllabus-lab/slope-field-generator"),
    topic("Degree", "Numerical Methods", "Advanced Mathematics", "available", "Bisection and Newton-Raphson method visualizer", "/syllabus-lab/newton-raphson-tangent-iteration"),
    ...
    topic("Degree", "Discrete Mathematics", "Advanced Mathematics", "available", "Truth tables, logic gates, and recurrence visualizer", "/syllabus-lab/truth-table-generator"),
    topic("Degree", "Graph Theory", "Advanced Mathematics", "available", "Graph builder with degree sequence and BFS explorer", "/syllabus-lab/graph-theory-basics"),
    ...
    topic("Degree", "Linear Programming and Optimization", "Advanced Mathematics", "available", "Feasible region and simplex method visualizer", "/syllabus-lab/operations-research-lp"),
    topic("Degree", "Operations Research", "Advanced Mathematics", "available", "Transportation and assignment problem visualizer", "/syllabus-lab/operations-research-lp"),
