...
export const syllabusLevels: SyllabusLevel[] = [
  level("class-7", "Class 7 Mathematics", "NCERT bridge into integers, rational numbers, equations, geometry, symmetry, mensuration, and solid shapes.", "Foundation", [
    ...
    topic("Class 7", "Data Handling", "Statistics", "available", "Native charts and probability practice", "/syllabus-lab/syllabus-concept-class-7-data-handling-mean", ["mean = sum/n"], ["Mean", "Median", "Mode", "Bar graph"]),
    topic("Class 7", "Simple Equations", "Algebra", "available", "Balance scale solving model", "/ncert/class-7-simple-equations", ["ax+b=c"], ["Equation", "Solution", "Inverse operation"]),
    ...
    topic("Class 7", "Algebraic Expressions", "Algebra", "available", "Expression tiles and substitution", "/syllabus-lab/syllabus-concept-class-7-algebraic-expressions-variables", ["terms", "like terms"], ["Variables", "Terms", "Substitution"]),
  ...
  level("class-8", "Class 8 Mathematics", "Foundation in numbers, algebra, geometry, mensuration, and data handling.", "Foundation", [
    ...
    topic("Class 8", "Linear Equations in One Variable", "Algebra", "available", "Balance scale solving ax + b = c", "/syllabus-lab/syllabus-concept-class-8-linear-equations-in-one-variable-solving", ["ax + b = c"], ["Solving", "Inverse operations"]),
    topic("Class 8", "Understanding Quadrilaterals", "Geometry", "available", "Polygon angle and property explorer", "/syllabus-visual/quadrilaterals", ["sum of interior angles"], ["Parallelogram", "Rhombus", "Rectangle"]),
    topic("Class 8", "Data Handling", "Statistics", "available", "Native charts and probability simulation", "/syllabus-lab/syllabus-concept-class-8-data-handling-bar-charts", ["mean = sum/n"], ["Bar charts", "Probability"]),
    ...
    topic("Class 8", "Algebraic Expressions and Identities", "Algebra", "available", "Identity tiles and expression expansion", "/ncert/class-8-algebraic-identities", ["(a+b)^2"], ["Terms", "Identities"]),
    topic("Class 8", "Mensuration", "Geometry", "available", "2D and 3D measurement explorer", "/syllabus-visual/mensuration", ["area", "volume"], ["Area", "Volume"]),
    ...
    topic("Class 8", "Direct and Inverse Proportions", "Algebra", "available", "Proportion graph visualizer", "/ncert/class-8-proportion", ["y = kx", "xy = k"], ["Graphs", "Ratios"]),
    topic("Class 8", "Factorisation", "Algebra", "available", "Factor tree and algebra tiles", "/syllabus-lab/syllabus-concept-class-8-factorisation-factors", ["ab+ac=a(b+c)"], ["Factors", "Common terms"]),
    topic("Class 8", "Introduction to Graphs", "Coordinate Geometry", "available", "Coordinate and line graph lab", "/syllabus-visual/coordinate-geometry", ["(x,y)", "y=mx+c"], ["Coordinates", "Line graph"]),
  ]),
  level("class-9", "Class 9 Mathematics", "Board foundation for polynomials, coordinate geometry, proofs, triangles, circles, and statistics.", "Foundation", [
    ...
    topic("Class 9", "Polynomials", "Algebra", "available", "Polynomial graph and roots", "/ncert/class-9-polynomials", ["p(x)", "remainder theorem"]),
    topic("Class 9", "Coordinate Geometry", "Coordinate Geometry", "available", "Coordinate plane and graph visualizer", "/syllabus-visual/coordinate-geometry", ["(x,y)"]),
    topic("Class 9", "Linear Equations in Two Variables", "Algebra", "available", "Two-line graph and solution lab", "/ncert/class-10-pair-linear", ["ax+by+c=0"]),
    ...
    topic("Class 9", "Lines and Angles", "Geometry", "available", "Angle relationship explorer", "/syllabus-lab/syllabus-concept-class-9-lines-and-angles-lines-and-angles", ["linear pair", "parallel lines"]),
    topic("Class 9", "Triangles", "Geometry", "available", "Triangle explorer with area and angles", "/syllabus-visual/triangles", ["A+B+C=180 deg"]),
    topic("Class 9", "Quadrilaterals", "Geometry", "available", "Quadrilateral property explorer", "/syllabus-visual/quadrilaterals"),
    topic("Class 9", "Circles", "Geometry", "available", "Circle explorer with sector and tangent", "/syllabus-visual/circles", ["C=2*pi*r", "A=pi*r^2"]),
    ...
    topic("Class 9", "Surface Areas and Volumes", "Geometry", "available", "3D shape explorer", "/syllabus-visual/mensuration", ["SA", "V"]),
    topic("Class 9", "Statistics", "Statistics", "available", "Mean, median, mode visualizer", "/syllabus-lab/syllabus-concept-class-9-statistics-statistics", ["mean", "median", "mode"]),
  ]),
  level("class-10", "Class 10 Mathematics", "Board-level foundation for algebra, geometry, trigonometry, mensuration, statistics, and probability.", "Intermediate", [
    ...
    topic("Class 10", "Polynomials", "Algebra", "available", "Polynomial and graph lab", "/ncert/class-10-polynomials"),
    topic("Class 10", "Pair of Linear Equations in Two Variables", "Algebra", "available", "Simultaneous equation lab", "/ncert/class-10-pair-linear", ["m1x+c1=m2x+c2"]),
    topic("Class 10", "Quadratic Equations", "Algebra", "available", "Parabola graph with sliders for a, b, c", "/ncert/class-10-quadratic", ["ax^2+bx+c=0", "D=b^2-4ac"], ["Roots", "Discriminant", "Vertex"]),
    ...
    topic("Class 10", "Triangles", "Geometry", "available", "Triangle explorer", "/syllabus-visual/triangles"),
    ...
    topic("Class 10", "Introduction to Trigonometry", "Trigonometry", "available", "Unit circle and wave visualizer", "/trigonometry/unit-circle"),
    ...
    topic("Class 10", "Circles", "Geometry", "available", "Circle tangent and sector explorer", "/syllabus-visual/circles"),
    topic("Class 10", "Areas Related to Circles", "Geometry", "available", "Sector and arc length visualizer", "/syllabus-visual/circles"),
    topic("Class 10", "Surface Areas and Volumes", "Geometry", "available", "3D shape lab", "/syllabus-visual/mensuration"),
    topic("Class 10", "Statistics", "Statistics", "available", "Statistics visualizer", "/syllabus-lab/syllabus-concept-class-10-statistics-statistics"),
    topic("Class 10", "Probability", "Probability", "available", "Probability simulator", "/syllabus-lab/syllabus-concept-class-10-probability-probability"),
  ]),
  level("class-11", "Class 11 Mathematics", "Advanced school mathematics connecting functions, trigonometry, analytic geometry, calculus, statistics, and probability.", "Advanced", [
    topic("Class 11", "Sets", "Advanced Mathematics", "available", "Venn diagram builder", "/syllabus-lab/venn-diagram-builder", ["n(A union B)=n(A)+n(B)-n(A intersection B)"], ["Union", "Intersection", "Complement", "Venn diagram"]),
    topic("Class 11", "Relations and Functions", "Advanced Mathematics", "available", "Mapping diagram and function graph test", "/syllabus-lab/function-mapping-arrows", ["f: A -> B"], ["Domain", "Codomain", "Range", "Function test"]),
    topic("Class 11", "Trigonometric Functions", "Trigonometry", "available", "Unit circle and waves", "/trigonometry/trigonometric-functions"),
    topic("Class 11", "Complex Numbers and Quadratic Equations", "Advanced Mathematics", "available", "Complex plane and Euler lab", "/syllabus-lab/argand-plane-plot"),
    topic("Class 11", "Linear Inequalities", "Algebra", "available", "Shaded half-plane visualizer", "/ncert/class-11-linear-inequalities"),
    ...
    topic("Class 11", "Binomial Theorem", "Algebra", "available", "Pascal triangle and expansion builder", "/ncert/class-11-binomial", ["(a+b)^n = sum C(n,k)a^(n-k)b^k"], ["Pascal triangle", "Binomial coefficients", "Expansion"]),
    topic("Class 11", "Sequences and Series", "Algebra", "available", "Sequence and sum visualizer", "/syllabus-visual/sequences-and-series"),
    topic("Class 11", "Straight Lines", "Algebra", "available", "Line graph and slope lab", "/syllabus-lab/syllabus-concept-class-11-straight-lines-straight-lines"),
    topic("Class 11", "Conic Sections", "Geometry", "available", "Ellipse, parabola, hyperbola focus-directrix model", "/ncert/class-11-conics", ["x^2/a^2 + y^2/b^2 = 1", "eccentricity e"], ["Circle", "Ellipse", "Parabola", "Hyperbola", "Focus"]),
    topic("Class 11", "Introduction to Three Dimensional Geometry", "Geometry", "available", "3D shape and coordinate explorer", "/syllabus-lab/syllabus-concept-class-11-introduction-to-three-dimensional-geometry-introduction-to-three-dimensional-geometry"),
    topic("Class 11", "Limits and Derivatives", "Calculus", "available", "Limits and derivative visualizer", "/calculus"),
    topic("Class 11", "Statistics", "Statistics", "available", "Statistics visualizer", "/syllabus-lab/syllabus-concept-class-11-statistics-statistics"),
    topic("Class 11", "Probability", "Probability", "available", "Probability simulators", "/syllabus-lab/syllabus-concept-class-11-probability-probability"),
  ]),
  level("class-12", "Class 12 Mathematics", "Senior secondary mathematics focused on calculus, matrices, vectors, probability, and optimization.", "Advanced", [
    topic("Class 12", "Relations and Functions", "Advanced Mathematics", "available", "Function composition and inverse function visualizer", "/syllabus-lab/function-mapping-arrows", ["f o g", "f^-1"], ["Composition", "Inverse function", "Domain", "Range"]),
    topic("Class 12", "Inverse Trigonometric Functions", "Trigonometry", "available", "Inverse trig graph visualizer", "/ncert/class-12-inverse-trig"),
    topic("Class 12", "Matrices", "Linear Algebra", "available", "Matrix transformation lab", "/syllabus-lab/matrix-transformation-grid"),
    topic("Class 12", "Determinants", "Linear Algebra", "available", "Determinant visualizer", "/syllabus-lab/matrix-transformation-grid"),
    ...
    topic("Class 12", "Differential Equations", "Calculus", "available", "Slope field and solution curve", "/syllabus-lab/slope-field-generator", ["dy/dx=f(x,y)"], ["Slope field", "Solution curve", "Initial value"]),
    topic("Class 12", "Vector Algebra", "Linear Algebra", "available", "Vector visualizer", "/syllabus-lab/vector-2d-3d-visualizer"),
    topic("Class 12", "Three Dimensional Geometry", "Geometry", "available", "3D geometry explorer", "/syllabus-lab/syllabus-concept-class-12-three-dimensional-geometry-three-dimensional-geometry"),
    topic("Class 12", "Linear Programming", "Advanced Mathematics", "available", "Feasible region and corner point optimization", "/ncert/class-12-linear-programming", ["maximize Z = c1*x + c2*y"], ["Feasible region", "Objective function", "Corner point"]),
    topic("Class 12", "Probability", "Probability", "available", "Probability and distribution lab", "/syllabus-lab/syllabus-concept-class-12-probability-probability"),
  ]),
  level("degree", "Degree Mathematics", "Undergraduate mathematics mapped to available labs and future advanced modules.", "Advanced", [
    topic("Degree", "Foundations and Logic", "Advanced Mathematics", "available", "Truth table generator", "/syllabus-lab/truth-table-generator", ["p -> q is equivalent to not p or q"], ["Statements", "Connectives", "Truth table", "Implication"]),
    topic("Degree", "Set Theory and Relations", "Advanced Mathematics", "available", "Venn diagrams and Hasse diagram", "/set-theory", ["A union B", "aRb"], ["Sets", "Relations", "Functions", "Partial orders"]),
    topic("Degree", "Abstract Algebra", "Advanced Mathematics", "available", "Group table and modular clock", "/algebraic-structures", ["a * b = (a + b) mod n"], ["Groups", "Cayley tables", "Modular arithmetic", "Lattices"]),
    topic("Degree", "Linear Algebra", "Linear Algebra", "available", "Vector, matrix, and eigenvector lab", "/syllabus-lab/matrix-transformation-grid"),
    ...
    topic("Degree", "Multivariable Calculus", "Calculus", "available", "3D surface, gradient, tangent plane", "/syllabus-lab/partial-derivative-slicer", ["partial f/partial x", "grad f"], ["Surface", "Gradient", "Partial derivative", "Tangent plane"]),
    topic("Degree", "Real Analysis", "Advanced Mathematics", "available", "Sequence convergence and epsilon neighbourhood", "/syllabus-lab/sequence-convergence", ["a_n -> L when |a_n-L| -> 0"], ["Sequences", "Limits", "Epsilon neighbourhood", "Convergence"]),
    topic("Degree", "Differential Equations", "Calculus", "available", "Slope field and Euler method", "/syllabus-lab/euler-vs-rk4-solution-comparison", ["y_(n+1)=y_n+h f(x_n,y_n)"], ["Slope fields", "Euler method", "RK4", "Solution curves"]),
    topic("Degree", "Numerical Methods", "Advanced Mathematics", "available", "Bisection and Newton-Raphson method", "/syllabus-lab/root-finding-animation", ["f(a)f(b)<0", "x_(n+1)=x_n-f(x_n)/f'(x_n)"], ["Bisection", "Newton-Raphson", "Iteration", "Error"]),
    topic("Degree", "Probability Theory", "Probability", "available", "Probability lab", "/syllabus-lab/probability-distribution-expectation-lab"),
    topic("Degree", "Mathematical Statistics", "Statistics", "available", "Statistics lab", "/syllabus-lab/statistical-inference-regression-lab"),
    topic("Degree", "Discrete Mathematics", "Advanced Mathematics", "available", "Recurrence and finite automata", "/discrete-world", ["recurrence", "finite automata"], ["Recurrence", "Automata", "Grammars", "Boolean structure"]),
    topic("Degree", "Graph Theory", "Advanced Mathematics", "available", "Graph builder, BFS, DFS, shortest path", "/graph-theory", ["sum deg(v)=2|E|"], ["Graphs", "BFS", "DFS", "Shortest path"]),
    topic("Degree", "Vector Calculus", "Linear Algebra", "available", "Vector field and direction lab", "/syllabus-lab/vector-calculus-field-theorems"),
    topic("Degree", "Complex Analysis", "Advanced Mathematics", "available", "Complex plane and Euler lab", "/syllabus-lab/complex-line-integral-lab"),
    topic("Degree", "Fourier Series and Transforms", "Trigonometry", "available", "Wave and signal visualizer", "/syllabus-lab/fourier-transform-spectrum-lab"),
    topic("Degree", "Linear Programming and Optimization", "Advanced Mathematics", "available", "Gradient descent and optimization lab", "/syllabus-lab/optimization-gradient-constraints-lab"),
    topic("Degree", "Operations Research", "Advanced Mathematics", "available", "Transportation and assignment problem", "/syllabus-lab/transportation-assignment-lab", ["minimize total cost = sum c_ij x_ij"], ["Transportation", "Assignment", "Supply", "Demand"]),
    topic("Degree", "Mathematical Modelling", "Advanced Mathematics", "available", "AI and real-life modelling demos", "/syllabus-lab/machine-learning-math-lab"),
  ]),
  level("engineering", "Engineering Mathematics", "B.Tech mathematics sequence covering M1, M2, M3, M4, discrete mathematics, probability, numerical methods, transforms, and optimization.", "Advanced", [
    ...
    topic("Engineering", "Eigenvalues, Eigenvectors and Diagonalization", "Engineering Linear Algebra", "available", "Eigenvector and diagonalization visual workflows", "/syllabus-lab/eigenvector-direction-visualizer", ["Av = lambda v", "A = PDP^-1"], ["Eigenvalues", "Eigenvectors", "Diagonalization"]),
    ...
    topic("Engineering", "First-Order Differential Equations", "Engineering Differential Equations", "available", "Slope fields, separable equations, linear equations, and engineering IVPs", "/syllabus-lab/slope-field-generator", ["dy/dx=f(x,y)"], ["Slope fields", "Separable ODE", "Initial value problem"]),
    ...
    topic("Engineering", "Probability Distributions", "Engineering Probability and Statistics", "available", "Discrete and continuous distributions, expectation, variance, and random variables", "/syllabus-lab/probability-distribution-expectation-lab", ["E(X)", "Var(X)", "P(A|B)"], ["Random variables", "Distributions", "Expectation"]),
    topic("Engineering", "Statistical Inference and Regression", "Engineering Probability and Statistics", "available", "Sampling, correlation, regression, confidence intervals, and hypothesis testing", "/syllabus-lab/statistical-inference-regression-lab", ["r", "y=a+bx"], ["Regression", "Sampling", "Hypothesis testing"]),
    ...
    topic("Engineering", "Discrete Mathematics for CSE", "Discrete Mathematics", "available", "Logic, sets, relations, functions, counting, recurrence, and Boolean algebra", "/syllabus-lab/discrete-math-cse-structure-lab", ["p -> q", "nCr", "recurrence"], ["Logic", "Relations", "Recurrence"]),
    topic("Engineering", "Graph Theory and Network Algorithms", "Graph Theory", "available", "Graph representation, traversals, shortest paths, trees, spanning trees, and coloring", "/syllabus-lab/graph-theory-basics", ["sum deg(v)=2|E|"], ["BFS", "DFS", "Shortest path", "Trees"]),
    ...
    topic("Engineering", "Optimization Techniques", "Optimization", "available", "Gradient descent, constrained optimization, convexity, and engineering objective functions", "/syllabus-lab/optimization-gradient-constraints-lab", ["x_new=x-alpha grad f"], ["Gradient descent", "Convexity", "Constraints"]),
    ...
    topic("Engineering", "Number Theory and Cryptography", "Number Theory", "available", "Modular arithmetic, Euclid algorithm, Euler theorem, RSA, and hashing ideas", "/syllabus-lab/number-theory-cryptography-lab", ["a congruent b (mod n)", "gcd(a,b)"], ["Modular arithmetic", "Primes", "RSA"]),
    topic("Engineering", "Mathematics for Machine Learning", "Machine Learning Mathematics", "available", "Linear algebra, gradients, probability, regression, and neural-network math", "/syllabus-lab/machine-learning-math-lab", ["activation(Wx+b)", "loss(theta)"], ["Vectors", "Gradients", "Regression"]),
  ]),
];
