...
const baseLinks: SiteLink[] = [
  ...
  },
  {
    ...
    path: "/board",
    description: "A responsive handwriting canvas for capturing, recognizing, correcting, and saving structured mathematical notation.",
    category: "Tools",
    keywords: ["math board", "handwriting recognition", "stylus canvas", "editable latex", "whiteboard"],
    priority: 0.9,
    changeFrequency: "weekly",
  },
  {
  ...
  },
  {
    ...
    description: "Phase 1-3 advanced lesson pathways with in-lesson labs, mastery checks, and capstone prompts for continued fractions, famous problems, inference, differential equations, and special functions.",
    category: "Learning",
    keywords: ["advanced lessons", "continued fractions", "famous problems", "statistical inference", "differential equations", "special functions", "mastery checks"],
    details: ["25 advanced lessons", "3 recommended pathways", "Local mastery tracking", "Studio-linked theory"],
    priority: 0.84,
    changeFrequency: "weekly",
  },
  {
  ...
  },
  {
    ...
    description: "Interactive studios for continued fractions, famous math problems, statistical inference, differential equations, and special mathematical functions.",
    category: "Advanced Mathematics",
    keywords: ["continued fractions", "famous math problems", "statistics inference", "differential equations", "special functions", "gamma", "beta"],
    details: ["Continued Fractions Lab", "Famous Problems Atlas", "Statistics Inference Studio", "Differential Equations Studio", "Special Functions Gallery"],
    priority: 0.8,
    changeFrequency: "weekly",
  },
];
