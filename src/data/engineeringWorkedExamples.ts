...
const examples: EngineeringWorkedExample[] = [
  ...
  example("engineering-differential-equations", "rc-decay-model", "RC circuit decay", "Solve dy/dt+2y=0 with y(0)=5.", ["Separate or use the linear ODE form.", "Get y=Ce^(-2t).", "Apply y(0)=5 to get C=5."], "y(t)=5e^(-2t), and y(0)=5.", "Voltage decay in a first-order circuit.", "/math/slope-fields"),
