...
const launchers: EngineeringLabLauncher[] = [
  ...
  launcher("engineering-calculus", "surface-workspace", "3D Surface Workspace", "workspace", "/workspace/3d?v_surface_scale=1&v_solid_height_radius=2.5&v_cross_section_z=0&v_scene_animation_speed=0.18", "surface scale, cross-section, 2D/3D panes", "Inspect engineering surfaces without changing the protected 3D layout.", ["z=f(x,y)", "level curves"]),
  ...
  launcher("engineering-differential-equations", "slope-fields", "Slope Field Lab", "concept-lab", "/math/slope-fields", "first-order ODE direction field", "Compare local slopes, IVPs, and solution curves.", ["dy/dx=f(x,y)", "y(x0)=y0"]),
  ...
  launcher("engineering-differential-equations", "cas-ode", "CAS ODE Notebook", "workspace", "/math-lab/cas-solver", "symbolic solve plus verification", "Use symbolic checks beside visual ODE intuition.", ["solve", "differentiate"]),
  ...
  launcher("engineering-linear-algebra", "matrix-sandbox", "Matrix Sandbox", "workspace", "/matrix-sandbox", "row operations and matrix experiments", "Test matrix workflows without disturbing vector scenes.", ["Ax=b", "RREF"]),
  launcher("engineering-linear-algebra", "linear-algebra-3d", "Vector and Eigen Lab", "workspace", "/linear-algebra", "3D vector pane, projections, eigenvectors", "Connect matrices to geometry, span, basis, and projections.", ["A v=lambda v", "proj_u v"]),
  ...
  launcher("transforms-signals", "fourier-animator", "Fourier Animator", "workspace", "/fourier-animator", "harmonic animation", "Show signal reconstruction before formal transform work.", ["harmonics", "series"]),
  ...
  launcher("partial-differential-equations", "surface-plotter", "Surface Plotter", "workspace", "/surface-plotter", "surface and level behavior", "Inspect PDE solution surfaces and boundary shapes.", ["u(x,y)", "nabla^2u"]),
  ...
  launcher("numerical-methods", "data-workspace", "Data and Spreadsheet Workspace", "workspace", "/workspace/data", "tables, regression, export", "Keep iteration tables and datasets in one workspace.", ["error", "iteration"]),

  launcher("probability-statistics-stochastic", "probability", "Probability Simulator", "concept-lab", "/math-lab/probability", "seeded simulations and distributions", "Connect theory with empirical engineering trials.", ["P(A)", "E[X]", "Var(X)"]),
  ...
  launcher("probability-statistics-stochastic", "stats-dashboard", "Statistics Dashboard", "workspace", "/probability-statistics", "histograms, z-scores, distributions", "Analyze engineering datasets through native charts.", ["z", "sigma", "mu"]),
  ...
  launcher("optimization-operations-research", "graph-theory", "Graph Theory Lab", "workspace", "/graph-theory", "networks, traversal, shortest path", "Use graph algorithms for OR network models.", ["paths", "trees"]),
  ...
  launcher("vector-calculus-fields", "3d-workspace", "3D Field Workspace", "workspace", "/workspace/3d?v_surface_scale=1&v_solid_height_radius=2.5&v_cross_section_z=0&v_scene_animation_speed=0.18", "3D scene plus 2D panes", "Use the protected 3D layout for field geometry context.", ["surface", "normal"]),
  launcher("vector-calculus-fields", "parametric", "Parametric Curves", "workspace", "/parametric-curves", "curve tracing and parameter motion", "Prepare line integral intuition with moving paths.", ["r(t)", "dr"]),
  ...
  launcher("complex-special-control", "complex-plane", "Complex Plane", "workspace", "/complex-numbers", "Argand plane and Euler form", "Keep complex arithmetic grounded in geometry.", ["z=re^(i theta)"]),
];
