...
export function generateNCERTPracticeVariant(
  name: GeneratorName,
  seed = 1,
): NCERTPracticeItem {
  ...
  if (name === "grade7-integers") {
    ...
    return item(
      ...
      `Find ${a} + ${b}.`,
      a + b,
      "Move right for a positive addend.",
      `${a} + ${b} = ${a + b}.`,
      s,
    );
  }
  if (name === "grade7-fractions") {
    ...
    return textItem(
      ...
      `Simplify ${denominator}/${denominator * 2}.`,
      "1/2",
      "Divide numerator and denominator by the same number.",
      `${denominator}/${denominator * 2} = 1/2.`,
      s,
    );
  }
  if (name === "grade7-decimals") {
    ...
    return item(
      ...
      `Find ${a.toFixed(1)} x ${b}.`,
      Number((a * b).toFixed(2)),
      "Multiply as whole numbers, then place decimals.",
      `${a.toFixed(1)} x ${b} = ${(a * b).toFixed(2)}.`,
      s,
      0.001,
    );
  }
  if (name === "grade7-percent") {
    ...
    return item(
      ...
      `Find ${s * 5}% of ${base}.`,
      (s * 5 * base) / 100,
      "Use percent/100 times base.",
      `${s * 5}% of ${base} = ${(s * 5 * base) / 100}.`,
      s,
    );
  }
  ...
  if (name === "class10-statistics") {
    ...
    return item(
      ...
      `Find mean of ${values.join(", ")}.`,
      s + 2,
      "Add values and divide by 3.",
  ...
  if (name === "class10-heights") {
    ...
    return item(
      ...
      `If tan(theta)=1 and distance=${distance}, find height.`,
      distance,
  ...
  if (name === "class12-bayes") {
    return item(
      ...
      "If P(A)=0.2, P(E|A)=0.5 and P(E)=0.1, find P(A|E).",
      1,
      "Use P(A)P(E|A)/P(E).",
      "0.2 x 0.5 / 0.1 = 1.",
      s,
