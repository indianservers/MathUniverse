...
export const ncertGapItems: NCERTGapItem[] = [
  ...
  { classLevel: "Class 10", chapter: "Arithmetic Progressions", status: "strong", currentCoverage: "Arithmetic progression term blocks and sum readout.", recommendedBuild: "Add derivation animation.", route: "/ncert/class-10-arithmetic-progressions" },
