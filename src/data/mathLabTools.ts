...
export type MathLabEngineFamily =
  | "Graph & Visual"
  | "Symbolic Solver"
  | "Geometry & Measure"
  | "Calculus & Analysis"
...
const toolCatalog: MathLabToolDefinition[] = [
  {
    ...
    description:
      "Interactive 2D graphing with multiple functions, zoom, pan, tables, roots, intercepts, trace mode, and numeric checks.",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Dynamic construction workspace with points, lines, circles, polygons, transforms, constraints, and live measurements.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Use the main step-by-step solver for solve, factor, expand, simplify, differentiate, integrate, statistics, matrices, and symbolic checks.",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Solve linear, quadratic, symbolic equations, and systems using guided tools.",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Explore domain, range, transformations, symmetry, and behavior of functions.",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Interact with unit circles, triangle ratios, waves, identities, inverse trig, heights, and 3D trig scenes.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Solve and visualize parabola tangents, ellipse focus-directrix equations, and hyperbola tangent relations.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Limits, derivatives, tangent lines, integrals, area under curves, Riemann sums, motion, and series blocks.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "B.Tech M1-M4 roadmap for calculus, differential equations, transforms, PDEs, numerical methods, probability, optimization, and field mathematics.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Matrix editor with determinant, inverse, rank, row-reduction, eigenvalues, systems, and transformation visualizers.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "2D and 3D vector operations, dot product, projections, components, span, basis, eigenvectors, and transformations.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Plot complex numbers, polar form, multiplication as rotation, roots of unity, transformations, and Euler form.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Arithmetic and geometric sequences, convergence, partial sums, convergence tests, and Taylor-style approximations.",
    useCases: [
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Expand constants and roots into continued fractions, compare convergents, and measure rational approximation error.",
    useCases: [
      "continued fractions",
      "convergents",
      "approximations",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Browse landmark conjectures, theorems, paradoxes, and open problems by status, theme, and core idea.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Estimate proportions with confidence intervals and compare sample-size, confidence-level, and hypothesis-test signals.",
    useCases: [
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Compare exact and numerical initial-value solutions for growth, decay, and first-order differential-equation models.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Explore Gamma, Beta, error-function, and zeta-style special function values through live parameter controls.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Translate, rotate, reflect, dilate, shear, and compare before/after behavior for objects, grids, vectors, and functions.",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Length, angle, area, perimeter, volume, surface area, live formulas, shape dimensions, and unit conversion support.",
  ...
  },
  {
    ...
    description:
      "Explore self-similarity, retained squares, removed squares, side scale, and retained area fractions for the Sierpinski carpet.",
    useCases: [
      "fractals",
      "self-similarity",
      "geometric sums",
  ...
  },
  {
    ...
    difficulty: "Foundation",
    description:
      "Build cube-stack solids and compare top, front, left, and right orthographic projections.",
    useCases: [
      "solid views",
      "cube stacks",
  ...
  },
  {
    ...
    difficulty: "Foundation",
    description:
      "Compare ratios, simplify them, and prove equality with cross-products.",
  ...
  },
  {
    ...
    difficulty: "Foundation",
    description:
      "Convert map distance, actual distance, and representative fraction with same-unit reasoning.",
  ...
  },
  {
    ...
    difficulty: "Foundation",
    description:
      "Divide a whole into multi-term ratio shares and convert parts to percentages or pie angles.",
  ...
  },
  {
    ...
    difficulty: "Foundation",
    description:
      "Compare constant-ratio and constant-product tables and graphs.",
    useCases: [
      "direct proportion",
      "inverse proportion",
      "constant ratio",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Render surfaces z = f(x, y) and inspect them with interactive 3D controls.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Build statements, generate truth tables, convert CNF/DNF, and animate inference and predicates.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Explore sets, Venn diagrams, relation matrices, Hasse diagrams, functions, and discrete structures.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Edit graphs and animate BFS, DFS, Dijkstra, MSTs, topological sort, planarity, circuits, and coloring.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Open the integrated browser-only lab for automata, grammars, Turing machines, and canonical discrete math modules.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Validate binary operations, semigroups, monoids, posets, lattices, Boolean laws, and logic gates.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    description:
      "Visualize counting trees, permutations, combinations, Pascal rows, multinomial terms, and inclusion-exclusion.",
    useCases: [
      "permutations",
      "combinations",
      "binomial theorem",
  ...
  },
  {
    ...
    difficulty: "Intermediate",
    description:
      "Walk through structured algebraic solution steps with rendered math.",
...
function engineFamilyFor(tool: MathLabToolDefinition): MathLabEngineFamily {
  const text =
    `${tool.title} ${tool.route} ${tool.useCases.join(" ")}`.toLowerCase();
  if (/probability|statistics|inference|random|data/.test(text))
    return "Data & Probability";
  if (
    /geometry|conic|measure|shape|solid|fractal|map scale|transform/.test(text)
  )
    return "Geometry & Measure";
  if (
    /calculus|derivative|integral|differential|series|special function|continued fraction|engineering/.test(
      text,
    )
  )
    return "Calculus & Analysis";
  if (
    /logic|set theory|graph theory|discrete|automata|algebraic structures|combinatorics|ratio|proportion|famous problems/.test(
      text,
    )
  )
    return "Discrete & Foundations";
  if (/solver|cas|equation|matrices|vectors/.test(text))
...
export const mathLabEngineFamilies = (
  Object.keys(checksByFamily) as MathLabEngineFamily[]
).map((name) => ({
  name,
  tools: mathLabTools.filter((tool) => tool.engineFamily === name).length,
  options: new Set(
    mathLabTools
      .filter((tool) => tool.engineFamily === name)
