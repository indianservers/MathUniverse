...
describe("GraphLessonAdapter", () => {
  it("routes lesson 163 to its dedicated transformation-order engine", () => {
    ...
    expect(html).toContain("editable-noncommutative-two-pipeline-input-substitution-steps-pointer-keyboard-draggable-linked-vertices-generated-curves-equations-observation-table-custom-order-practice-notes-and-navigation");
  ...
  it("routes lesson 162 to its dedicated combined-transformations engine", () => {
    ...
    expect(html).toContain("editable-combined-horizontal-shift-vertical-scale-and-shift-reorderable-transformation-pipeline-pointer-keyboard-draggable-vertex-generated-parent-step-final-parabolas-point-trace-tabs-practice-and-navigation");
  ...
  it("routes lesson 160 to its dedicated x-axis reflection engine", () => {
    ...
    expect(html).toContain("editable-x-axis-reflection-scale-shift-and-sample-pointer-keyboard-draggable-reflected-point-generated-parent-and-reflected-parabolas-mirror-lines-point-mapping-rule-cards-and-navigation");
