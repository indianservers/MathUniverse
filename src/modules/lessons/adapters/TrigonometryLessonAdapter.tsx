...
import InverseTrigTargetLesson265 from "./InverseTrigTargetLesson265";
...
export function LegacyRightTriangleRatiosTargetLesson({
  lesson,
  resetToken,
  onInteraction,
}: LessonAdapterProps) {
