...
import SegmentGivenLengthTargetLesson205 from "./SegmentGivenLengthTargetLesson205";
...
export default function Geometry2DLessonAdapter({
  ...
  if (lesson.id === 199) {
    return <PointOnObjectTargetLesson199 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 202) {
    return <AttachDetachTargetLesson202 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 203) {
  ...
  if (lesson.id === 205) {
    return <SegmentGivenLengthTargetLesson205 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 167) {
  ...
  if (lesson.id === 182) {
    return <BarycentricCoordinatesTargetLesson182 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 250) {
