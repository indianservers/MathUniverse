...
export default function AlgebraCasLessonAdapter({ lesson, resetToken, onInteraction }: LessonAdapterProps) {
  ...
  if (lesson.id === 108) {
    return <MultiStepEquationsTargetLesson108 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 109) {
  ...
  if (lesson.id === 111) {
    return <LinearEquationsTargetLesson111 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 112) {
  ...
  if (lesson.id === 114) {
    return <QuadraticEquationsTargetLesson114 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 115) {
    return <PolynomialEquationsTargetLesson115 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 116) {
  ...
  if (lesson.id === 119) {
    return <LogarithmicEquationsTargetLesson119 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 120) {
    return <TrigonometricEquationsTargetLesson120 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 121) {
  ...
  if (lesson.id === 123) {
    return <CompoundInequalitiesTargetLesson123 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 124) {
    return <QuadraticInequalitiesTargetLesson124 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 125) {
    return <PolynomialInequalitiesTargetLesson125 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.id === 126) {
    return <TwoVariableInequalitiesTargetLesson126 lesson={lesson} resetToken={resetToken} onInteraction={onInteraction} />;
  }
  if (lesson.categorySlug === "algebra" && lesson.id >= 127 && lesson.id <= 128) {
