...
describe("AlgebraCasLessonAdapter", () => {
  ...
  it("routes lesson 125 to its dedicated draggable polynomial sign analyzer", () => {
    ...
    expect(html).toContain(
      "editable-polynomial-inequality-three-pointer-keyboard-draggable-roots-multiplicity-aware-sign-chart-linked-graph-factorization-test-intervals-endpoint-inclusion-union-practice-model",
    );
    expect(html).toContain('aria-label="Drag polynomial root 1"');
  ...
  it("routes lesson 126 to its dedicated draggable coordinate half-plane model", () => {
    ...
    expect(html).toContain(
      "editable-two-variable-inequality-pointer-keyboard-draggable-boundary-intercept-slope-and-test-point-clipped-half-plane-live-substitution-dashed-solid-region-practice-model",
    );
  ...
  it("routes lesson 127 to its dedicated draggable feasible-overlap model", () => {
    ...
    expect(html).toContain(
      "editable-system-of-two-inequalities-pointer-keyboard-draggable-diagonal-intercept-slope-horizontal-limit-and-probe-clipped-overlap-feasible-region-live-two-constraint-checks-practice-model",
    );
  ...
  it("routes lesson 128 to its dedicated draggable numerical root finder", () => {
    ...
    expect(html).toContain(
      "editable-numerical-root-finder-pointer-keyboard-draggable-coarse-and-zoom-brackets-bisection-trial-table-sign-change-rounded-approximation-residual-check-cosine-practice-model",
    );
