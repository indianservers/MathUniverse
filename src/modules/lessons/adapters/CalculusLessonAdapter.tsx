...
export default function CalculusLessonAdapter(props: LessonAdapterProps) {
  ...
  if (props.lesson.id === 282) return <TypesOfDiscontinuityTargetLesson282 {...props} />;
  if (props.lesson.id === 283) return <EpsilonDeltaTargetLesson283 {...props} />;
  ...
  if (props.lesson.id === 292) return <QuotientRuleTargetLesson292 {...props} />;
  if (props.lesson.id === 293) return <ChainRuleTargetLesson293 {...props} />;
  if (props.lesson.id === 294) return <ImplicitDifferentiationTargetLesson294 {...props} />;
  ...
  if (props.lesson.id === 300) return <InflectionPointsTargetLesson300 {...props} />;
  ...
  if (props.lesson.id === 311) return <AreaBetweenCurvesTargetLesson311 {...props} />;
  if (props.lesson.id === 312) return <SubstitutionTargetLesson312 {...props} />;
  ...
  if (props.lesson.id === 321) return <SurfaceAreaRevolutionTargetLesson321 {...props} />;
