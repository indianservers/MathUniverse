...
import ConicIdentificationTargetLesson10151 from "../schoolTargets/ConicIdentificationTargetLesson10151";
...
import InterceptPlaneTargetLesson10161 from "../schoolTargets/InterceptPlaneTargetLesson10161";
import PointPlaneDistanceTargetLesson10162 from "../schoolTargets/PointPlaneDistanceTargetLesson10162";
import PlaneAngleTargetLesson10163 from "../schoolTargets/PlaneAngleTargetLesson10163";
import LinePlaneAngleTargetLesson10164 from "../schoolTargets/LinePlaneAngleTargetLesson10164";
import OneSidedLimitsTargetLesson10165 from "../schoolTargets/OneSidedLimitsTargetLesson10165";
import ContinuityPointTargetLesson10166 from "../schoolTargets/ContinuityPointTargetLesson10166";
...
import IntegrationSubstitutionTargetLesson10180 from "../schoolTargets/IntegrationSubstitutionTargetLesson10180";
...
import HomogeneousFirstOrderTargetLesson10189 from "../schoolTargets/HomogeneousFirstOrderTargetLesson10189";
import LinearFirstOrderTargetLesson10190 from "../schoolTargets/LinearFirstOrderTargetLesson10190";
...
import InverseAdjointTargetLesson10195 from "../schoolTargets/InverseAdjointTargetLesson10195";
...
function SchoolLessonBody({
  ...
  if (lesson.numericId === 10147)
    return <ParabolaTangentTargetLesson10147 lesson={lesson} />;
  if (lesson.numericId === 10148)
  ...
  if (lesson.numericId === 10151)
    return <ConicIdentificationTargetLesson10151 lesson={lesson} />;
  if (lesson.numericId === 10152)
    return <DirectionRatiosTargetLesson10152 lesson={lesson} />;
  if (lesson.numericId === 10153)
  ...
  if (lesson.numericId === 10161)
    return <InterceptPlaneTargetLesson10161 lesson={lesson} />;
  if (lesson.numericId === 10162)
    return <PointPlaneDistanceTargetLesson10162 lesson={lesson} />;
  if (lesson.numericId === 10163)
    return <PlaneAngleTargetLesson10163 lesson={lesson} />;
  if (lesson.numericId === 10164)
    return <LinePlaneAngleTargetLesson10164 lesson={lesson} />;
  if (lesson.numericId === 10165)
    return <OneSidedLimitsTargetLesson10165 lesson={lesson} />;
  if (lesson.numericId === 10166)
    return <ContinuityPointTargetLesson10166 lesson={lesson} />;
  if (lesson.numericId === 10167)
    return <ContinuityIntervalTargetLesson10167 lesson={lesson} />;
  if (lesson.numericId === 10168)
  ...
  if (lesson.numericId === 10180)
    return <IntegrationSubstitutionTargetLesson10180 lesson={lesson} />;
  if (lesson.numericId === 10181)
    return <IntegrationByPartsTargetLesson10181 lesson={lesson} />;
  if (lesson.numericId === 10182)
  ...
  if (lesson.numericId === 10185)
    return <AreaBetweenCurvesTargetLesson10185 lesson={lesson} />;
  if (lesson.numericId === 10186)
  ...
  if (lesson.numericId === 10189)
    return <HomogeneousFirstOrderTargetLesson10189 lesson={lesson} />;
  if (lesson.numericId === 10190)
    return <LinearFirstOrderTargetLesson10190 lesson={lesson} />;
  if (lesson.numericId === 10191)
    return <GeneralParticularSolutionsTargetLesson10191 lesson={lesson} />;
  if (lesson.numericId === 10192)
  ...
  if (lesson.numericId === 10195)
    return <InverseAdjointTargetLesson10195 lesson={lesson} />;
  if (lesson.numericId === 10196)
    return <DeterminantAreaTargetLesson10196 lesson={lesson} />;
  if (lesson.numericId === 10197)
