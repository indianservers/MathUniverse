...
describe("lesson pages", () => {
  ...
  it("renders the dedicated composition pipeline for lesson 10121", () => {
    const html = renderToStaticMarkup(
      <MemoryRouter
        initialEntries={[
    ...
    expect(html).toContain(
      "dedicated-editable-function-composition-pipeline-engine",
    );
    expect(html).toContain('data-x="0"');
    expect(html).toContain('data-f-value="1"');
    expect(html).toContain('data-composed="2"');
  ...
  it("renders the dedicated differentiability-continuity engine for lesson 10171", () => {
    const html = renderToStaticMarkup(<MemoryRouter initialEntries={["/lessons/school/class-12/class-12-formal-calculus-differentiability-versus-continuity"]}><Routes><Route path="/lessons/school/:levelSlug/:lessonSlug" element={<SchoolLessonPage />} /></Routes></MemoryRouter>);
    expect(html).toContain('data-testid="school-mockup-0845"');
    expect(html).toContain("dedicated-one-sided-derivative-comparison-engine");
    expect(html).toContain('data-case="corner"');
    expect(html).toContain('data-continuous="true"');
  ...
  it("renders the dedicated adjoint transpose engine for lesson 10194", () => {
    const html = renderToStaticMarkup(<MemoryRouter initialEntries={["/lessons/school/class-12/class-12-matrices-and-determinants-adjoint-of-a-matrix"]}><Routes><Route path="/lessons/school/:levelSlug/:lessonSlug" element={<SchoolLessonPage />} /></Routes></MemoryRouter>);
    expect(html).toContain('data-testid="school-mockup-0868"');
    expect(html).toContain("dedicated-adjoint-transpose-verification-engine");
    expect(html).toContain('data-row="1"');
    expect(html).toContain('data-column="2"');
    expect(html).toContain('data-minor="-5"');
    expect(html).toContain('data-sign="-1"');
    expect(html).toContain('data-cofactor="5"');
    expect(html).toContain('data-destination="2,1"');
    expect(html).toContain('data-determinant="22"');
  });
