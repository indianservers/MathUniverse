...
const details: Record<number, Detail> = {
  ...
  10214: probabilityDetail("Bayes' Theorem", "Bayes' theorem reverses conditional probability using prior probabilities and observed evidence.", "Multiply each prior by its likelihood, then divide the chosen case by the total probability of the evidence.", "The denominator counts all ways the observed evidence can happen.", "tree_diagram", "In Bayes' theorem, what denominator combines all cases for the evidence?", "total probability", "Bayes theorem", String.raw`P(B_j\mid A)=\frac{P(B_j)P(A\mid B_j)}{\sum_i P(B_i)P(A\mid B_i)}`, ["DENOMINATOR_FORGOTTEN", "Using only the chosen case and forgetting other possible cases.", "Use the total probability denominator before reversing the conditional probability."]),
