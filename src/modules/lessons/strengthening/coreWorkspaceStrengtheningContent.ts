import { applyCoreWorkspaceHandOverlay } from "./coreWorkspaceHandAuthoredOverlay";
...
export const coreWorkspaceStrengthenedLessons: Record<number, StrengthenedLesson> = Object.fromEntries(
  coreWorkspaceSeeds.map((item) => [item.id, applyCoreWorkspaceHandOverlay(coreWorkspaceLesson(item))]),
);
