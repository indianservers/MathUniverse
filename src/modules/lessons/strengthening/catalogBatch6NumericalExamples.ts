...
export const batch6NumericalExamples: Readonly<Record<number, readonly NumericalExampleSeed[]>> = {
  2001: [
    ...
    calculation("Are decimal digits the same as partial quotients?", "Quotients come from floor-and-reciprocal steps.", "no.", "no"),
  ],
  2002: [
    calculation("For 7/5, what is the first partial quotient a0?", "a0 = floor(7/5).", "1.", "1"),
    calculation("After a0=1 for 7/5, the remainder is 2/5. What reciprocal starts the next step?", "Reciprocal of 2/5 is 5/2.", "5/2.", "5/2"),
  ...
  2006: [
    ...
    calculation("Is a long hailstone path a proof for all n?", "One orbit is one example.", "no.", "no"),
  ],
  2007: [
    calculation("Write 28 as a sum of two primes if possible: 14+14. Is 28 even and >2?", "28 is even.", "yes.", "yes"),
    calculation("Goldbach concerns even integers greater than what?", "Even integers > 2.", "2.", "2"),
  ...
  2008: [
    ...
    calculation("Does RH describe zeros of ζ(s) or of a random polynomial?", "It is about the Riemann zeta function.", "zeta.", "zeta"),
    calculation("Does a finite list of zeros prove RH?", "RH is an infinite statement.", "no.", "no"),
  ],
  2009: [
  ...
  2010: [
    ...
    calculation("What is the theorem's color bound for planar maps?", "At most four colors suffice.", "4.", "4"),
  ...
  2012: [
    ...
    calculation("Can you skip the Margin of Error and Sample Size restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  2013: [
    ...
    calculation("Can you skip the Hypothesis Tests restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  2014: [
  ...
  2016: [
    ...
    calculation("Does a slope field give the unique solution without an initial point?", "A field shows directions.", "no.", "no"),
  ],
  2017: [
    ...
    calculation("Is Euler's method exact for every DE?", "It is a first-order approximation.", "no.", "no"),
  ],
  2018: [
    ...
    calculation("Can you drop the initial value and still name the unique IVP solution?", "An IVP needs y(t0).", "no.", "no"),
  ],
  2019: [
    calculation("Logistic carrying capacity K=60. What is the equilibrium y=K?", "y'=ry(1-y/K) vanishes at 0 and K.", "60.", "60"),
    calculation("If y is much smaller than K, the early growth looks like what?", "1-y/K≈1.", "exponential.", "exponential"),
    calculation("Does logistic growth stay exponential forever?", "The (1-y/K) term slows it.", "no.", "no"),
  ],
  2020: [
    calculation("For y''+ω^2 y=0 with ω=6, the period is 2π/ω. What is it?", "T=2π/6.", "2π/6.", "2π/6"),
    calculation("Does a larger ω make a shorter period?", "T=2π/ω.", "yes.", "yes"),
    calculation("Is the first-order Euler slope enough to write the oscillator equation?", "The oscillator is second order.", "no.", "no"),
  ],
  2021: [
    calculation("Γ(n)=(n-1)! for positive integers. What is Γ(8)?", "Γ(8)=7!.", "5040.", "5040"),
    calculation("What is Γ(1)?", "Γ(1)=0!=1.", "1.", "1"),
    calculation("Is Γ(x) defined only for integers?", "The gamma function extends factorial to reals (except nonpositive integers).", "no.", "no"),
  ],
  2022: [
    calculation("B(a,b)=Γ(a)Γ(b)/Γ(a+b). If a=1 and b=2, B(1,2)=Γ(1)Γ(2)/Γ(3). What is it?", "Γ(1)=1, Γ(2)/Γ(3)=1/2.", "1/2.", "1/2"),
    calculation("Is B(a,b) symmetric in a and b?", "B(a,b)=B(b,a).", "yes.", "yes"),
    calculation("Does B(a,b) equal Γ(a+b)?", "It is a ratio of gammas.", "no.", "no"),
  ],
  2023: [
    calculation("erf(0) equals what?", "The integrand is odd and the interval collapses.", "0.", "0"),
    calculation("What value does erf(x) approach as x→∞?", "erf is a scaled integral of e^{-t^2}.", "1.", "1"),
    calculation("Is erf(x) a probability itself without scaling?", "Normal probabilities use erf after scaling by √2.", "no.", "no"),
  ],
  2024: [
    calculation("ζ(2)=π^2/6. Is ζ(2) greater than 1?", "The series 1+1/4+1/9+... > 1.", "yes.", "yes"),
    calculation("For even integers, are many zeta values known in closed form?", "Even zeta values involve π^{2k}.", "yes.", "yes"),
  ...
  2025: [
    ...
    calculation("Are Bessel zeros equally spaced like sine zeros?", "Spacing changes and amplitude decays.", "no.", "no"),
  ],
  10057: [
  ...
  10067: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 60° and 70°. What is the sum?", "60+70.", "130.", "130"),
    calculation("Do longer rays make a larger angle?", "Angle is turn, not ray length.", "no.", "no"),
  ],
  10068: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 70° and 20°. What is the sum?", "70+20.", "90.", "90"),
    calculation("Do longer rays make a larger angle?", "Angle is turn, not ray length.", "no.", "no"),
  ],
  10069: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 80° and 30°. What is the sum?", "80+30.", "110.", "110"),
    calculation("Do longer rays make a larger angle?", "Angle is turn, not ray length.", "no.", "no"),
  ],
  10070: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 90° and 40°. What is the sum?", "90+40.", "130.", "130"),
    calculation("Do longer rays make a larger angle?", "Angle is turn, not ray length.", "no.", "no"),
  ],
  10071: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
  ...
  10074: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 50° and 20°. What is the sum?", "50+20.", "70.", "70"),
    calculation("Do longer rays make a larger angle?", "Angle is turn, not ray length.", "no.", "no"),
  ],
  10075: [
  ...
  10079: [
    calculation("In Heron's Formula Derivation, evaluate the labelled model at input 10.", "Substitute 10 into the Heron's Formula Derivation rule.", "70.", "70"),
    calculation("Compare the Heron's Formula Derivation outputs at 10 and 17. What is the difference?", "Second input 17.", "7.", "7"),
    calculation("Can you skip the Heron's Formula Derivation restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10080: [
  ...
  10083: [
    ...
    calculation("Can you skip the Distance Formula restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10084: [
    ...
    calculation("Can you skip the Midpoint Formula restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10085: [
    ...
    calculation("Can you skip the Internal Section Formula restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10086: [
    ...
    calculation("Can you skip the External Section Formula restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10087: [
  ...
  10096: [
    ...
    calculation("Does Tangent Perpendicular to Radius treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10097: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Tangent Lengths from an External Point treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10098: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 50° and 20°. What is the sum?", "50+20.", "70.", "70"),
  ...
  10100: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Shadow-Length Modelling treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10101: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
  ...
  10105: [
    ...
    calculation("Can you skip the Less-Than Cumulative Frequency restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10106: [
    ...
    calculation("Can you skip the More-Than Cumulative Frequency restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10107: [
    ...
    calculation("Can you skip the Less-Than Ogive restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10108: [
    ...
    calculation("Can you skip the More-Than Ogive restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10109: [
    ...
    calculation("Do you find the median before sorting?", "Median uses position.", "no.", "no"),
  ],
  10110: [
    ...
    calculation("Can you skip the Frustum of a Cone restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10111: [
  ...
  10112: [
    ...
    calculation("Can you skip the Types of Relations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10113: [
    ...
    calculation("Can you skip the Reflexive Relations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10114: [
    ...
    calculation("Can you skip the Symmetric Relations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10115: [
    ...
    calculation("Can you skip the Transitive Relations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10116: [
    ...
    calculation("Can you skip the Equivalence Relations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10117: [
  ...
  10119: [
    calculation("In Into Functions, evaluate the labelled model at input 10.", "Substitute 10 into the Into Functions rule.", "50.", "50"),
    calculation("Compare the Into Functions outputs at 10 and 15. What is the difference?", "Second input 15.", "5.", "5"),
    calculation("Can you skip the Into Functions restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10120: [
  ...
  10121: [
    ...
    calculation("Can you skip the Composition of Functions restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10122: [
  ...
  10123: [
    ...
    calculation("Can you skip the Binary Operations restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10124: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Domain and Range of Trigonometric Functions treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10125: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Transformation of Trigonometric Graphs treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10126: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does General Solutions of Trigonometric Equations treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10127: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Principal Solutions treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10128: [
  ...
  10134: [
    ...
    calculation("Can you skip the Binomial Expansion restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10135: [
    calculation("In General Term, evaluate the labelled model at input 10.", "Substitute 10 into the General Term rule.", "30.", "30"),
    calculation("Compare the General Term outputs at 10 and 13. What is the difference?", "Second input 13.", "3.", "3"),
    calculation("Can you skip the General Term restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10136: [
    ...
    calculation("Can you skip the Middle Term restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10137: [
    ...
    calculation("Can you skip the Independent Term restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10138: [
  ...
  10139: [
    ...
    calculation("Can you skip the Pascal Identity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10140: [
    ...
    calculation("Can you skip the Combinatorial Interpretation restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10141: [
    ...
    calculation("Can you skip the Parabola Standard Forms restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10142: [
    ...
    calculation("Can you skip the Focus-Directrix Definition restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10143: [
    calculation("In Ellipse Standard Forms, evaluate the labelled model at input 10.", "Substitute 10 into the Ellipse Standard Forms rule.", "50.", "50"),
    calculation("Compare the Ellipse Standard Forms outputs at 10 and 15. What is the difference?", "Second input 15.", "5.", "5"),
    calculation("Can you skip the Ellipse Standard Forms restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10144: [
    ...
    calculation("Can you skip the Hyperbola Standard Forms restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10145: [
    ...
    calculation("Can you skip the Eccentricity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10146: [
    ...
    calculation("Can you skip the Parametric Coordinates restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10147: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Tangent to a Parabola treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10148: [
    ...
    calculation("Can you skip the Normal to a Parabola restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10149: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Tangent to an Ellipse treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10150: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Tangent to a Hyperbola treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10151: [
  ...
  10152: [
    ...
    calculation("Can you skip the Direction Ratios restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10153: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Direction Cosines treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10154: [
  ...
  10157: [
    ...
    calculation("Can you skip the Skew Lines restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10158: [
    ...
    calculation("Can you skip the Shortest Distance Between Lines restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10159: [
    calculation("Solve 3x = 30.", "Divide by 3.", "10.", "10"),
  ...
  10160: [
    ...
    calculation("Can you skip the Point-Normal Form restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10161: [
    ...
    calculation("Can you skip the Intercept Form of a Plane restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10162: [
    ...
    calculation("Can you skip the Distance from Point to Plane restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10163: [
    calculation("A right angle is what fraction of a 360° turn?", "A full turn is 360°.", "90.", "90"),
    calculation("Add 60° and 70°. What is the sum?", "60+70.", "130.", "130"),
  ...
  10166: [
    ...
    calculation("Can you skip the Continuity at a Point restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10167: [
  ...
  10168: [
    ...
    calculation("Can you skip the Removable Discontinuity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10169: [
    ...
    calculation("Can you skip the Jump Discontinuity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10170: [
    ...
    calculation("Can you skip the Infinite Discontinuity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10171: [
    ...
    calculation("Can you skip the Differentiability versus Continuity restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10172: [
    ...
    calculation("Can you skip the Rolle's Theorem restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10173: [
  ...
  10175: [
    calculation("Find sin 30°.", "sin 30° = 1/2.", "1/2.", "1/2"),
    calculation("Find cos 60°.", "cos 60° = 1/2.", "1/2.", "1/2"),
    calculation("Does Tangents and Normals treat 90° the same as 90 radians?", "Degrees and radians are different units.", "no.", "no"),
  ],
  10176: [
    ...
    calculation("Can you skip the Increasing and Decreasing Functions restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10177: [
    ...
    calculation("Can you skip the Local Maxima and Minima restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10178: [
    ...
    calculation("Can you skip the Absolute Maxima and Minima restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10179: [
  ...
  10180: [
    ...
    calculation("Can you skip the Integration by Substitution restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10181: [
    ...
    calculation("Can you skip the Integration by Parts restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10182: [
    ...
    calculation("Can you skip the Integration by Partial Fractions restriction and still trust the chart?", "The restriction is part of the definition.", "no.", "no"),
  ],
  10183: [
  ...
  10186: [
    calculation("Solve 6x = 30.", "Divide by 6.", "5.", "5"),
  ...
  10188: [
    calculation("Solve 2x = 14.", "Divide by 2.", "7.", "7"),
  ...
  10190: [
    calculation("Solve 4x = 36.", "Divide by 4.", "9.", "9"),
  ...
  10191: [
    calculation("Solve 5x = 50.", "Divide by 5.", "10.", "10"),
  ...
  10192: [
    calculation("Solve 6x = 18.", "Divide by 6.", "3.", "3"),
  ...
  10193: [
    ...
    calculation("What is the size of a 7 by 5 product if inner sizes match?", "Rows from the first matrix.", "7 by 5.", "7 by 5"),
  ...
  10194: [
    ...
    calculation("What is the size of a 2 by 6 product if inner sizes match?", "Rows from the first matrix.", "2 by 6.", "2 by 6"),
    calculation("Can you add a 2×3 matrix to a 3×2 matrix?", "Addition needs the same shape.", "no.", "no"),
  ],
  10195: [
    calculation("Find det([[6,3],[0,7]]).", "6*7-3*0.", "42.", "42"),
    calculation("What is the size of a 3 by 7 product if inner sizes match?", "Rows from the first matrix.", "3 by 7.", "3 by 7"),
    calculation("Can you add a 2×3 matrix to a 3×2 matrix?", "Addition needs the same shape.", "no.", "no"),
  ],
  10196: [
  ...
  10197: [
    ...
    calculation("What is the size of a 5 by 9 product if inner sizes match?", "Rows from the first matrix.", "5 by 9.", "5 by 9"),
    calculation("Can you add a 2×3 matrix to a 3×2 matrix?", "Addition needs the same shape.", "no.", "no"),
  ],
  10198: [
    calculation("Find det([[9,6],[0,10]]).", "9*10-6*0.", "90.", "90"),
    calculation("What is the size of a 6 by 10 product if inner sizes match?", "Rows from the first matrix.", "6 by 10.", "6 by 10"),
    calculation("Can you add a 2×3 matrix to a 3×2 matrix?", "Addition needs the same shape.", "no.", "no"),
  ],
  10199: [
  ...
  10200: [
    ...
    calculation("Must an optimal vertex be checked if the region is bounded and linear?", "The extreme-value theorem for LPP uses corners.", "yes.", "yes"),
    calculation("Is an infeasible system still solved by picking any corner of the empty set?", "No feasible point exists.", "no.", "no"),
  ],
  10201: [
  ...
  10207: [
    calculation("A feasible polygon has corner values 10, 13, 16. If we maximise, which is largest?", "Compare 10, 13, 16.", "16.", "16"),
    calculation("Must an optimal vertex be checked if the region is bounded and linear?", "The extreme-value theorem for LPP uses corners.", "yes.", "yes"),
    calculation("Is an infeasible system still solved by picking any corner of the empty set?", "No feasible point exists.", "no.", "no"),
  ],
  10208: [
  ...
  10219: [
    ...
    calculation("If trials are dependent, does the binomial PMF still apply automatically?", "Independence is an assumption.", "no.", "no"),
  ],
  10220: [
