...
const rawSeeds = [
  ...
  ["function-basics", "Function Basics", "functions", "basic", ["variables"], ["domain-range", "linear-functions"], ["graphs"], undefined, ["Input-output rules"], "/workspace/graph", "graphs"],
  ["domain-range", "Domain and Range", "functions", "basic", ["function-basics"], ["inverse-trigonometry"], ["graph-interpretation"], undefined, ["Valid inputs"], "/workspace/graph", "graphs"],
  ["linear-functions", "Linear Functions", "functions", "basic", ["linear-equations"], ["intersections-graphs"], ["slope"], ["y=mx+c"], undefined, "/workspace/graph", "graphs"],
  ["quadratic-functions", "Quadratic Functions", "functions", "intermediate", ["quadratic-equations"], ["parabola-basics"], ["graph-interpretation"], ["y=ax^2+bx+c"], undefined, "/workspace/graph", "graphs"],
  ["polynomial-functions", "Polynomial Functions", "functions", "intermediate", ["polynomials"], ["calculus-limits"], ["quadratic-functions"], undefined, ["Curve modelling"], "/workspace/graph", "graphs"],
  ["exponential-functions", "Exponential Functions", "functions", "intermediate", ["exponents"], ["logarithmic-functions"], ["geometric-progression"], ["y=a^x"], undefined, "/workspace/graph", "graphs"],
  ["logarithmic-functions", "Logarithmic Functions", "functions", "intermediate", ["exponential-functions"], ["calculus-limits"], ["exponents"], ["log_b(xy)=log_b x+log_b y"], ["Logarithm product theorem"], "/workspace/graph", "graphs"],
  ...
  ["graph-interpretation", "Graph Interpretation", "functions", "basic", ["domain-range"], ["calculus-limits"], ["statistics-mean"], undefined, ["Data reading"], "/workspace/graph", "graphs"],
