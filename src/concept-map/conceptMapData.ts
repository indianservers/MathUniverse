...
export const conceptCategoryInfo: Record<ConceptCategory, ConceptCategoryInfo> =
  {
    ...
    "advanced-pure": {
      id: "advanced-pure",
      label: "Advanced Pure Mathematics",
      color: "#be123c",
      softColor: "#ffe4e6",
    },
  };
...
function makeNode(seed: NodeSeed, index: number): ConceptNode {
  ...
  return {
    ...
    title: seed.title,
    shortTitle:
      seed.title.length > 20
        ? seed.title
            .replace("Trigonometric", "Trig")
    ...
    masteryLevel:
      seed.difficulty === "foundation"
        ? 65
        : seed.difficulty === "basic"
          ? 35
          : 0,
    x: Math.min(
      1708,
      Math.max(52, origin.x + (column - 1.5) * 86 + (row % 2) * 20),
    ),
...
const rawSeeds = [
  [
    ...
    "foundation",
    [],
    ["whole-numbers", "factors-multiples"],
    [],
    undefined,
    ["Counting", "Ranks"],
    "/number-systems",
  ...
  [
    ...
    "basic",
    ["fractions", "decimals"],
    ["ratio-proportion", "probability-basics"],
    ["data-collection"],
  ...
  [
    ...
    "basic",
    ["fractions"],
    ["right-triangle-trigonometry", "similarity"],
    ["percentages"],
    ["a:b = c:d"],
  ...
  [
    ...
    "basic",
    ["natural-numbers"],
    ["radicals", "exponential-functions", "logarithmic-functions"],
  ...
  [
    ...
    "basic",
    ["exponents"],
    ["irrational-numbers", "quadratic-formula"],
    ["real-numbers"],
  ...
  [
    ...
    "basic",
    ["algebraic-expressions"],
    ["simultaneous-equations", "linear-functions"],
    ["equation-of-line"],
    ["ax+b=0"],
    undefined,
    "/problem-solver",
  ...
  [
    ...
    "intermediate",
    ["linear-equations"],
    ["calculus-applications", "olympiad-inequality-reasoning"],
    ["number-line"],
    ["|a+b| <= |a|+|b|"],
  ...
  [
    ...
    "intermediate",
    ["algebraic-expressions"],
    ["factorization", "polynomial-functions"],
    ["exponents"],
    undefined,
    ["Curves"],
    "/algebra",
  ...
  [
    ...
    "algebra",
    "intermediate",
    ["factorization", "linear-equations"],
    ["quadratic-formula", "quadratic-functions"],
    ["parabola-basics"],
    ["ax^2+bx+c=0"],
  ...
  [
    ...
    "basic",
    ["triangles"],
    ["distance-formula", "right-triangle-trigonometry"],
    ["radicals"],
    ["a^2+b^2=c^2"],
    ["Pythagorean theorem"],
  ...
  [
    ...
    "basic",
    ["points-lines-angles"],
    ["tangents", "chords", "circle-equation"],
    ["unit-circle"],
    ["C=2pi r"],
    undefined,
    "/geometry",
  ...
  [
    ...
    "geometry",
    "basic",
    ["number-line", "points-lines-angles"],
    ["cartesian-plane"],
    ["coordinate-plane"],
    undefined,
    ["Maps"],
  ...
  [
    ...
    "trigonometry",
    "intermediate",
    ["coordinate-plane", "right-triangle-trigonometry"],
    ["trig-identities", "trig-graphs"],
    ["sine", "cosine"],
  ...
  [
    ...
    "visual-proofs",
    "basic",
    ["points-lines-angles", "algebraic-expressions"],
    ["pythagoras", "algebraic-identities", "trig-pythagorean-identity"],
    ["geometry-chase"],
    undefined,
    ["Teaching proof intuition"],
    "/visual-proofs",
    "geometry",
  ],
  [
  ...
  [
    ...
    "coordinate-geometry",
    "basic",
    ["pythagoras", "coordinate-plane"],
    ["midpoint-formula", "circle-equation"],
    ["vectors"],
  ...
  [
    ...
    "coordinate-geometry",
    "intermediate",
    ["midpoint-formula", "ratio-proportion"],
    ["vectors"],
    ["coordinate-plane"],
    undefined,
    ["Dividing a route"],
  ...
  [
    ...
    "coordinate-geometry",
    "basic",
    ["coordinate-plane", "ratio-proportion"],
    ["equation-of-line", "linear-functions"],
    ["derivatives"],
    ["m=(y2-y1)/(x2-x1)"],
    undefined,
    "/geometry/coordinate-geometry",
  ...
  [
    ...
    "coordinate-geometry",
    "intermediate",
    ["quadratic-functions", "coordinate-plane"],
  ...
  [
    ...
    undefined,
    ["Survey data"],
    "/set-theory/venn-diagram-engine",
    "sets",
  ],
  [
    "inclusion-exclusion",
    ...
    "intermediate",
    ["union", "intersection"],
    ["probability-basics", "counting-strategies"],
    ["venn-diagrams"],
  ...
  [
    ...
    "intermediate",
    ["factorization"],
    ["permutations", "counting-strategies"],
    ["binomial-theorem"],
    ["nCr"],
  ...
  [
    ...
    "calculus",
    "intermediate",
    ["function-basics", "graph-interpretation"],
    ["continuity"],
    ["slope"],
    undefined,
    ["Instant behavior"],
  ...
  [
    ...
    "calculus",
    "intermediate",
    ["calculus-limits", "slope"],
    ["differentiation-rules", "calculus-applications"],
    ["tangents"],
    ["dy/dx"],
    ["Mean value theorem"],
    "/math/derivatives",
  ...
  [
    ...
    "calculus",
    "intermediate",
    ["area", "calculus-derivatives"],
    ["integration-area", "differential-equations-basics"],
    ["volume"],
    undefined,
    ["Accumulation"],
    "/math/integration",
  ...
  [
    ...
    "calculus",
    "advanced",
    ["calculus-derivatives", "calculus-integration"],
    ["slope-fields"],
    ["functions"],
    undefined,
    ["Population models"],
  ...
  [
    ...
    "foundation",
    ["natural-numbers"],
    ["olympiad-number-theory", "counting-strategies"],
    ["sequences"],
    undefined,
    ["Contest strategy"],
    "/olympyard",
  ...
  [
    ...
    "olympiad",
    "advanced",
    ["angle-theorems", "congruence"],
    ["olympiad-inequality-reasoning"],
    ["similarity"],
    undefined,
    ["Proof contests"],
  ...
  [
    ...
    "olympiad",
    "advanced",
    ["function-basics", "algebraic-manipulation"],
    ["olympiad-inequality-reasoning"],
    ["logic-statements"],
    undefined,
    ["Contest functions"],
  ...
  [
    ...
    "computation",
    "intermediate",
    ["logic-statements", "counting-strategies"],
  ...
  [
    ...
    "computation",
    "intermediate",
    ["sets", "counting-strategies"],
    ["algorithms", "network-models"],
    ["matrices"],
    undefined,
    ["Networks", "Routes"],
    "/graph-theory",
  ...
  [
    ...
    "computation",
    "advanced",
    ["statistics-mean", "matrices", "optimization"],
    ["data-science"],
    ["linear-transformations"],
    undefined,
  ...
  [
    ...
    "applied",
    "intermediate",
    ["statistics-mean", "probability-basics", "graph-interpretation"],
    ["machine-learning"],
    ["data-collection"],
    undefined,
    ["Data modelling"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["calculus-applications", "inequalities"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["linear-equations", "inequalities", "coordinate-plane"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["percentages", "exponential-functions", "statistics-mean"],
    ["economics"],
    ["probability-basics"],
    undefined,
    ["Risk", "Compound interest"],
    "/engineering-math",
    "applied",
  ],
  [
    ...
    "applied",
    "intermediate",
    ["linear-functions", "optimization", "statistics-mean"],
    ["mathematical-finance"],
    ["data-science"],
    undefined,
    ["Supply and demand"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["differential-equations-basics", "linear-transformations"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["vectors", "matrices", "calculus-integration"],
    ["control-theory"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["vectors", "calculus-derivatives", "differential-equations-basics"],
    ["engineering-mathematics"],
    ["vector-calculus"],
    undefined,
    ["Motion", "Fields"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["vectors", "calculus-derivatives", "calculus-integration"],
    ["mathematical-physics"],
    ["linear-transformations"],
    undefined,
    ["Fields", "Flow"],
  ...
  [
    ...
    "advanced-pure",
    "advanced",
    ["points-lines-angles", "sets"],
    ["differential-geometry"],
    ["continuity"],
    undefined,
    ["Shape without measurement"],
    "/theorems",
    "pureAdvanced",
  ],
  [
    ...
    "advanced-pure",
    "advanced",
    ["calculus-derivatives", "points-lines-angles", "vectors"],
    ["topology"],
    ["mathematical-physics"],
    undefined,
    ["Curved spaces"],
  ...
  [
    ...
    "advanced-pure",
    "advanced",
    ["complex-numbers-concept", "calculus-derivatives"],
    ["fractals"],
    ["function-basics"],
    undefined,
    ["Analytic functions"],
  ...
  [
    ...
    "advanced-pure",
    "advanced",
    ["sequences", "complex-numbers-concept"],
    ["chaos-theory"],
    ["complex-analysis"],
    undefined,
    ["Self-similarity"],
  ...
  [
    ...
    "advanced-pure",
    "advanced",
    ["differential-equations-basics", "fractals"],
    ["dynamical-systems"],
    ["probability-basics"],
    undefined,
  ...
  [
    ...
    "advanced-pure",
    "advanced",
    ["differential-equations-basics", "sequences"],
    ["chaos-theory"],
    ["control-theory"],
    undefined,
    ["Changing systems"],
  ...
  [
    ...
    "applied",
    "advanced",
    ["probability-basics", "optimization"],
    ["economics"],
    ["logic-statements"],
    undefined,
    ["Strategy"],
...
const seeds: NodeSeed[] = rawSeeds.map(
  ([
    id,
    title,
    category,
...
function relationshipEdges() {
  const edges = conceptNodes.flatMap((node) => [
    ...node.prerequisites.map((source) =>
      edge("prerequisite", source, node.id, "prerequisite", 4),
    ),
    ...node.nextConcepts.map((target) =>
      edge("builds-into", node.id, target, "builds into", 3),
    ),
    ...node.relatedConcepts.map((target) =>
      edge("related", node.id, target, "related", 1),
    ),
    ...(node.formulas?.length
      ? [edge("formula-link", node.id, node.id, "related formula", 1)]
      : []),
    ...(node.theorems?.length
      ? [edge("theorem-link", node.id, node.id, "theorem available", 1)]
      : []),
    ...(node.availableModules.visualProof
      ? [edge("visual-proof-link", node.id, node.id, "visual proof", 1)]
      : []),
  ]);
  const map = new Map<string, ConceptEdge>();
  [...edges, ...explicitEdges].forEach((item) => {
    if (
      conceptNodes.some((node) => node.id === item.source) &&
      conceptNodes.some((node) => node.id === item.target)
    ) {
