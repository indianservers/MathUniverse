...
const specs: WorkspaceCommandSpec[] = [
  ...
  command("SolveSystem", "Algebra", "SolveSystem[equation1, equation2]", "Solve simultaneous equations exactly where possible.", true, ["SolveSystem[x+y=5, x-y=1]"], ["System", "Simultaneous"]),
