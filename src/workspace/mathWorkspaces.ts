...
export const mathWorkspaces: MathWorkspaceDefinition[] = [
  ...
  },
  {
    ...
    icon: "ChartSpline",
    description: "Plot and analyse functions, equations, inequalities and data.",
    shortDescription: "Plot functions, equations and data.",
    group: "construct-graph",
    accent: "#0891b2",
    badge: "Plot",
    formula: "y = f(x)",
  ...
  },
  {
    ...
    shortDescription: "Explore surfaces and spatial equations.",
    group: "construct-graph",
    accent: "#4f46e5",
    badge: "Surface",
    formula: "z = f(x, y)",
