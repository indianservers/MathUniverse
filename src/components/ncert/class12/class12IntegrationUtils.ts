  ...
  > = {
    "substitution-cos-x2": {
      ...
      steps: [
        "Let u = x^2.",
        "Then du = 2x dx.",
        "Integral becomes integral cos(u) du.",
        "Answer is sin(u) + C = sin(x^2) + C.",
      ],
    },
    "by-parts-x-exp": {
      ...
      steps: [
        ...
        "Use integral u dv = uv - integral v du.",
        "Answer is x e^x - e^x + C.",
      ],
    },
    "partial-fractions": {
      ...
      steps: [
        ...
        "Write A/(x - 1) + B/(x + 1).",
        "Solve A = 1/2 and B = -1/2.",
        "Integrate each log term.",
      ],
    },
    "even-definite": {
      ...
      steps: [
        ...
        "Double the right-half integral.",
      ],
    },
    "odd-definite": {
      ...
      steps: [
        "Check f(-x) = -f(x).",
        "Split at 0.",
        "Match equal opposite signed areas.",
        "Sum is 0.",
      ],
    },
    "area-between": {
      ...
      steps: [
        "Find top curve: y = x.",
        "Find bottom curve: y = x^2.",
        "Integrate top minus bottom on [0, 1].",
        "Area = 1/6.",
      ],
    },
  };
