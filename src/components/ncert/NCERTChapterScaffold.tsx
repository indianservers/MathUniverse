              ...
              <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(280px,380px)]">
                {bankQuestions.length > 0 ? (
                  ...
                  <GuidedScaffoldPanel
                    ...
                    notice={
                      recap[0] ?? "The visual shows the important structure."
                    }
                    tryIt={
                      recap[1] ?? "Change one value and predict the result."
                    }
                ...
                <SectionCard
                  ...
                  description="Use these NCERT-style starting points before making your own."
                >
