...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Intelligent AI Board", route: "/board", icon: "PenLine", searchTerms: ["board", "canvas", "handwriting", "math recognition", "stylus", "whiteboard"] },
      {
        title: "Concept Map",
        route: "/concept-map",
        icon: "Network",
      ...
      },
      {
        ...
        route: "/lessons",
        icon: "BookOpen",
        searchTerms: ["lessons", "interactive lessons", "geogebra style", "guided activities", "phase 1", "advanced concept lessons"],
        children: [
          { title: "All Lessons", route: "/lessons", icon: "BookOpen" },
          { title: "Advanced Concept Lessons", route: "/lessons/advanced-concepts", icon: "Sigma", searchTerms: ["continued fractions", "famous problems", "statistics inference", "differential equations", "special functions"] },
          { title: "School Syllabus Remediation", route: "/lessons/school", icon: "BookOpen" },
        ],
      },
