...
export const navSections: NavSection[] = [
  {
    ...
    icon: "Home",
    items: [
      { title: "Dashboard", route: "/", icon: "Home", description: "Overview, highlights, and latest modules.", searchTerms: ["home", "start", "overview", "dashboard"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Geometry", route: "/geometry", icon: "Shapes", description: "Construct and measure triangles, circles, theorems, and solids.", searchTerms: ["geometry studio", "shapes", "triangles", "circles", "pythagoras", "solids"] },
      {
        ...
        route: "/algebra",
        icon: "FunctionSquare",
        description: "Manipulate expressions, equations, functions, and algebraic structures.",
        searchTerms: ["algebra studio", "equations", "expressions", "functions", "polynomials"],
        children: [
          { title: "Studio Home", route: "/algebra", icon: "Home" },
          { title: "Expressions & Algebra Tiles", route: "/algebra/expressions", icon: "FunctionSquare" },
          { title: "Equations & Inequalities", route: "/algebra/equations", icon: "Sigma" },
          { title: "Functions & Transformations", route: "/algebra/functions", icon: "LineChart" },
          { title: "Polynomials", route: "/algebra/polynomials", icon: "ChartSpline" },
          { title: "Systems of Equations", route: "/algebra/systems", icon: "Workflow" },
          { title: "Exponents, Radicals & Logarithms", route: "/algebra/exponents-logs", icon: "Sparkles" },
          { title: "Sequences & Progressions", route: "/algebra/sequences", icon: "BarChart3" },
          { title: "Algebraic Proof", route: "/algebra/proof", icon: "BookOpen" },
          { title: "CAS Explorer", route: "/algebra/cas", icon: "Calculator", searchTerms: ["existing cas workspace", "symbolic algebra"] },
        ],
      },
      ...
      { title: "Studio Project Center", route: "/studio-projects", icon: "GitFork", description: "Save, share, transfer, and teach with projects that work across every studio.", searchTerms: ["studio projects", "share", "transfer", "checkpoint", "accessibility", "teacher activities"] },
    ],
  },
  {
    title: "Graphing & CAS",
    ...
    items: [
      {
        ...
        searchTerms: ["desmos", "plot", "graph", "function", "surface", "parametric", "polar"],
        children: [
          { title: "2D Graphing Calculator", route: "/math-lab/graphing-calculator", icon: "ChartSpline" },
          { title: "3D Graph Studio", route: "/math-lab/3d-graphing", icon: "Cuboid" },
          { title: "Function Explorer", route: "/math-lab/function-explorer", icon: "Waves" },
          { title: "Graph Workspace", route: "/workspace/graph", icon: "FunctionSquare" },
      ...
      },
      {
        ...
        searchTerms: ["wolfram", "cas", "solver", "compute", "calculator", "spreadsheet", "data"],
        children: [
          { title: "Step-by-Step Solver", route: "/problem-solver", icon: "Sigma" },
          ...
          { title: "Data / CAS Workspace", route: "/workspace/data", icon: "Table2" },
          { title: "Spreadsheet Workspace", route: "/workspace/data/spreadsheet", icon: "Table2" },
          { title: "CAS Results", route: "/workspace/data/results", icon: "Sigma" },
      ...
      },
      {
        ...
        searchTerms: ["geogebra", "geometry", "construct", "2d geometry", "3d geometry", "shapes"],
        children: [
          { title: "2D Geometry Workspace", route: "/workspace/geometry", icon: "Shapes" },
          { title: "3D Geometry Workspace", route: "/workspace/3d", icon: "Cuboid" },
          { title: "2D/3D Shapes Explorer", route: "/shapes", icon: "Cuboid" },
          { title: "AR Math Lab", route: "/modules/ar-math-lab", icon: "ScanLine" },
        ],
      },
      { title: "Intelligent AI Board", route: "/board", icon: "PenLine", description: "Canvas, handwriting, recognition, and teaching board.", searchTerms: ["board", "canvas", "handwriting", "math recognition", "stylus", "whiteboard"] },
    ],
  },
  {
    ...
    items: [
      {
        ...
        route: "/lessons",
        icon: "BookOpen",
        description: "Lesson home, school lessons, and advanced concept lessons.",
        searchTerms: ["lessons", "interactive lessons", "guided activities", "school", "advanced concept lessons"],
        children: [
          { title: "All Lessons", route: "/lessons", icon: "BookOpen" },
          { title: "School Lessons", route: "/lessons/school", icon: "BookOpen" },
          { title: "Advanced Concept Lessons", route: "/lessons/advanced-concepts", icon: "Sigma" },
      ...
      },
      {
        ...
        searchTerms: ["practice", "quiz", "olympiad", "mock test", "daily challenge", "worked examples"],
        children: [
          { title: "Olympyard", route: "/olympyard", icon: "Trophy" },
          { title: "Mock Test", route: "/olympyard/mock-test", icon: "ClipboardList" },
      ...
      { title: "Teacher Studio", route: "/workspace/teach", icon: "Presentation", description: "Open guided classroom workspace templates.", searchTerms: ["teacher", "classroom", "presentation", "worksheet"] },
    ],
  },
  {
    ...
    items: [
      {
        ...
        children: [
          ...
          { title: "Proportional Reasoning Formulas", route: "/formulas/proportional-reasoning-2", icon: "GitFork", searchTerms: ["ratio formulas", "map scale formulas", "direct inverse proportion formulas"] },
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Proportional Reasoning Theorems", route: "/theorems/proportional-reasoning", icon: "GitFork" },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Ratio and Proportion Proofs", route: "/visual-proofs/ratios", icon: "GitFork", searchTerms: ["ratio proof", "cross multiplication proof", "map scale proof", "direct inverse proportion proof"] },
      ...
      { title: "Visual Showcase", route: "/visual-showcase", icon: "Sparkles", searchTerms: ["showcase", "visualizer", "demo", "gallery"] },
    ],
  },
  {
    ...
    icon: "ClipboardList",
    items: [
      { title: "Syllabus", route: "/syllabus", icon: "BookOpen", description: "Curriculum map and topic planner.", searchTerms: ["syllabus", "curriculum", "planner", "coverage"] },
      {
        ...
        children: [
          { title: "All NCERT Labs", route: "/ncert", icon: "BookOpen" },
          {
            ...
            icon: "GitFork",
            searchTerms: ["class 8", "proportional reasoning", "ratio", "map scale", "representative fraction", "cross multiplication", "inverse proportion"],
            children: [
              { title: "Equivalent Ratios", route: "/ncert/class-8-proportional-reasoning-2?tab=equivalent-ratios", icon: "GitFork" },
              { title: "Map Scale", route: "/ncert/class-8-proportional-reasoning-2?tab=map-scale", icon: "Ruler" },
              { title: "Ratio Splitter", route: "/ncert/class-8-proportional-reasoning-2?tab=ratio-splitter", icon: "Network" },
              { title: "Direct and Inverse", route: "/ncert/class-8-proportional-reasoning-2?tab=direct-inverse", icon: "Workflow" },
              { title: "Visual Formula Lab", route: "/visual-formulas/proportional-reasoning-2", icon: "Sigma" },
            ],
          },
          {
      ...
      { title: "School Lessons", route: "/lessons/school", icon: "BookOpen", description: "Remediation lessons aligned to school levels.", searchTerms: ["school lessons", "remediation", "class", "grade"] },
      { title: "Curriculum Evidence", route: "/curriculum-evidence", icon: "ClipboardList", searchTerms: ["coverage", "evidence", "curriculum"] },
      { title: "Coverage Dashboard", route: "/coverage-dashboard", icon: "BarChart3", searchTerms: ["coverage", "dashboard", "audit"] },
    ],
  },
  {
    title: "Advanced Labs",
    ...
    items: [
      {
        ...
        searchTerms: ["continued fractions", "famous problems", "statistics inference", "differential equations", "special functions"],
        children: [
          { title: "Continued Fractions", route: "/math-lab/continued-fractions", icon: "Sigma" },
          { title: "Famous Problems", route: "/math-lab/famous-problems", icon: "BookOpen" },
          { title: "Statistics Inference", route: "/math-lab/stats-inference", icon: "BarChart3" },
          { title: "Differential Equations", route: "/math-lab/differential-equations", icon: "FunctionSquare" },
          { title: "Special Functions", route: "/math-lab/special-functions", icon: "Binary" },
        ],
      },
      {
        title: "Magic Maths",
      ...
      { title: "AR Math Lab", route: "/modules/ar-math-lab", icon: "ScanLine", searchTerms: ["ar", "augmented reality", "mixed reality", "xr", "webxr", "camera math", "3d graph ar"] },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "BarChart3",
        searchTerms: ["statistics", "probability", "mean", "median", "mode", "variance", "standard deviation", "regression", "distribution", "atlas", "normal", "binomial", "poisson", "beta", "weibull", "sampling", "inference", "hypothesis", "confidence interval", "p value", "bayesian", "markov", "stochastic", "entropy", "kl divergence", "survey sampling", "doe", "design of experiments", "quality control", "sqc", "time series", "nonparametric", "survival", "official statistics", "actuarial", "statistical computing"],
        children: [
          { title: "Statistics and Probability", route: "/probability-statistics", icon: "BarChart3" },
          { title: "Probability Statistics Module", route: "/probability-statistics/module", icon: "Sigma", searchTerms: ["probability statistics module", "distribution atlas", "inference", "bayesian", "stochastic"] },
          {
            title: "Distribution Atlas",
            route: "/probability-statistics/distributions",
            icon: "BarChart3",
            searchTerms: ["all distributions", "probability distributions", "pmf", "pdf", "cdf", "normal", "binomial", "poisson", "gamma", "beta", "weibull"],
            children: [
              { title: "All Distributions", route: "/probability-statistics/distributions", icon: "BarChart3" },
              { title: "Normal Distribution", route: "/probability-statistics/distributions/normal", icon: "FunctionSquare" },
              { title: "Binomial Distribution", route: "/probability-statistics/distributions/binomial", icon: "BarChart3" },
              { title: "Poisson Distribution", route: "/probability-statistics/distributions/poisson", icon: "BarChart3" },
              { title: "Beta Distribution", route: "/probability-statistics/distributions/beta", icon: "FunctionSquare" },
              { title: "Weibull Distribution", route: "/probability-statistics/distributions/weibull", icon: "FunctionSquare" },
            ],
          },
          {
            ...
            icon: "BarChart3",
            searchTerms: ["sampling distribution", "confidence interval", "hypothesis testing", "p value", "power", "anova", "regression diagnostics"],
            children: [
              { title: "Sampling Distributions", route: "/probability-statistics/sampling", icon: "BarChart3" },
              { title: "Inference and Tests", route: "/probability-statistics/inference", icon: "Sigma" },
              { title: "Regression Diagnostics", route: "/probability-statistics/regression", icon: "LineChart" },
            ],
          },
          {
            ...
            icon: "Network",
            searchTerms: ["bayesian", "prior", "posterior", "markov chain", "queue", "reliability", "entropy", "kl divergence", "mixture model", "multivariate normal"],
            children: [
              { title: "Bayesian Reasoning", route: "/probability-statistics/bayesian", icon: "GitFork" },
              { title: "Stochastic Processes", route: "/probability-statistics/stochastic", icon: "Network" },
              { title: "Advanced Models", route: "/probability-statistics/advanced-models", icon: "Sigma" },
            ],
          },
          {
            ...
            icon: "ClipboardList",
            searchTerms: ["survey sampling", "design of experiments", "doe", "quality control", "sqc", "time series", "nonparametric", "multivariate", "advanced inference", "official statistics", "survival analysis", "actuarial", "statistical computing", "applied modelling", "grouped data", "ogive"],
            children: [
              { title: "Survey Sampling Studio", route: "/probability-statistics/survey-sampling", icon: "ClipboardList" },
              { title: "Design of Experiments Studio", route: "/probability-statistics/design-of-experiments", icon: "FlaskConical" },
              { title: "Statistical Quality Control", route: "/probability-statistics/quality-control", icon: "BarChart3" },
              { title: "Time Series Studio", route: "/probability-statistics/time-series", icon: "LineChart" },
              { title: "Nonparametric Tests", route: "/probability-statistics/nonparametric", icon: "Sigma" },
              { title: "Multivariate Analysis", route: "/probability-statistics/multivariate-analysis", icon: "Network" },
              { title: "Advanced Inference", route: "/probability-statistics/advanced-inference", icon: "BrainCircuit" },
              { title: "Official Statistics", route: "/probability-statistics/official-statistics", icon: "Table2" },
              { title: "Survival Analysis", route: "/probability-statistics/survival-analysis", icon: "LineChart" },
              { title: "Actuarial and Reliability", route: "/probability-statistics/actuarial-reliability", icon: "Network" },
              { title: "Statistical Computing", route: "/probability-statistics/statistical-computing", icon: "Workflow" },
              { title: "Applied Modelling", route: "/probability-statistics/applied-modelling", icon: "FlaskConical" },
              { title: "School Statistics Polish", route: "/probability-statistics/school-statistics", icon: "BarChart3" },
            ],
          },
    ...
    items: [
      {
        ...
        icon: "BrainCircuit",
        children: [
          { title: "2D Graph", route: "/math-lab/graphing-calculator", icon: "ChartSpline" },
          { title: "Function Explorer", route: "/math-lab/function-explorer", icon: "Waves" },
          ...
          { title: "Solver", route: "/problem-solver", icon: "Sigma", searchTerms: ["problem solver", "CAS", "algebra solver", "step-by-step solving"] },
