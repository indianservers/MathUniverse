...
function buildCommandItems(): CommandItem[] {
  ...
  const actions: CommandItem[] = [
    ...
    { id: "action:workspace-3d", kind: "route", title: "Open 3D Geometry", subtitle: "Surface, solid and vector tools", group: "Template", route: "/workspace?mode=3d", keywords: "3d geometry surface solid vector workspace", icon: Layers3 },
    { id: "action:workspace-geometry", kind: "route", title: "Open 2D Geometry", subtitle: "2D construction tools and object inspector", group: "Template", route: "/workspace?mode=geometry", keywords: "2d geometry constructor point line circle polygon", icon: MousePointer2 },
