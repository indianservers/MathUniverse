...
function AppFooter() {
  ...
  if (isAreaTarget || isFixedAngleTarget || isTranslationTarget || isReflectionTarget || isRotationPointTarget || isTransformationMappingTarget || isMovingLinkageTarget) return null;
  if (isRelationTarget) {
    return (
