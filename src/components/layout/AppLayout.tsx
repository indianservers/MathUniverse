...
function AppFooter() {
  ...
  if (isPointReflectionTarget) {
    return (
      <footer className="mx-auto h-[118px] w-full max-w-[1440px] pl-[24px] pr-[19px] pt-0" aria-label="Site footer">
        <div className="relative h-[106px] rounded-lg border border-slate-200 bg-white/80 px-4 py-3 shadow-sm">
