...
export const squareOfSumPhaseTwoConfig: PhaseTwoProofConfig = {
  ...
  liveValues: ({ a, b }) => [
    ...
    { id: "full", label: "Full area", value: (a + b) ** 2, exactValue: `(${a} + ${b})^2 = ${(a + b) ** 2}` },
    { id: "parts", label: "Decomposed area", value: `${a ** 2} + ${a * b} + ${a * b} + ${b ** 2}` },
    { id: "simplified", label: "Simplified", value: `${a ** 2} + ${2 * a * b} + ${b ** 2}` },
  ],
