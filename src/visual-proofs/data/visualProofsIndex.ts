...
const geometryProofs: GeometryProofSeed[] = [
  ...
  {
    id: "intersecting-chords-theorem",
    title: "Intersecting Chords Theorem",
    slug: "intersecting-chords-theorem",
    shortDescription: "Move two crossing chords and compare the products of their segment lengths.",
    longDescription: "When two chords intersect inside a circle, the product of the two pieces of one chord equals the product of the two pieces of the other chord: a × b = c × d.",
    difficulty: "Intermediate",
    tags: ["circle", "chord", "power of a point", "area", "product"],
    estimatedTime: "9 minutes",
    prerequisites: ["Circle", "Chord", "Rectangle area"],
    learningOutcomes: ["Verify the intersecting chords theorem", "Connect length products to equal areas", "Test the invariant by moving the chords"],
    componentKey: "IntersectingChordsProof",
  },
  {
    id: "center-and-circumference-angles",
    title: "Center and Circumference Angles",
    slug: "center-and-circumference-angles",
    shortDescription: "Compare angles subtended by the same arc at the center and circumference.",
    longDescription: "For the same chord AB, the angle at the center is twice the angle at any point C on the opposite circumference: angle AOB = 2 angle ACB.",
    difficulty: "Intermediate",
    tags: ["circle", "inscribed angle", "central angle", "arc"],
    estimatedTime: "8 minutes",
    prerequisites: ["Circle", "Angles", "Chord"],
    learningOutcomes: ["Relate central and inscribed angles", "Track the shared arc", "Verify the factor of two dynamically"],
    componentKey: "CenterCircumferenceAnglesProof",
  },
  {
  ...
  {
    id: "shear-preserves-area",
    title: "Shear Preserves Area",
    slug: "shear-preserves-area",
    shortDescription: "Slide horizontal layers while keeping base and height fixed.",
    longDescription: "A rectangle shears into a parallelogram with the same base and perpendicular height, so the area and determinant remain unchanged.",
    difficulty: "Beginner",
    tags: ["geometry", "shear", "area", "determinant", "parallelogram"],
    estimatedTime: "7 minutes",
    prerequisites: ["Rectangle area", "Parallelogram area"],
    learningOutcomes: ["See shear preserve horizontal slices", "Keep base and height fixed", "Connect shear with determinant one"],
    componentKey: "ShearPreservesAreaProof",
  },
  {
  ...
  {
    id: "orthographic-projection-from-cube-stacks",
    title: "Orthographic Projections from Cube Stacks",
    slug: "orthographic-projection-from-cube-stacks",
    shortDescription: "Build a cube stack and read top, front, left, and right views from maximum heights.",
    longDescription: "The top view records occupied grid cells. The front and side views collapse depth and keep the maximum visible height in each column or row.",
    difficulty: "Beginner",
    tags: ["solid views", "orthographic projection", "cube stacks", "front view", "top view", "side view"],
    estimatedTime: "8 minutes",
    prerequisites: ["Cubes", "Grid rows and columns", "Maximum"],
    learningOutcomes: ["Read top/front/side projections", "Use maximum stack heights", "Explain deterministic projection orientation"],
    componentKey: "OrthographicProjectionFromCubeStacksProof",
  },
  {
    id: "non-unique-solid-projections",
    title: "Non-Unique Solid Projections",
    slug: "non-unique-solid-projections",
    shortDescription: "Compare two different cube solids that cast the same top, front, and side views.",
    longDescription: "Projection views can hide internal or lower cubes. This demonstration shows why reconstruction is not always unique unless cube count or extra constraints are supplied.",
    difficulty: "Intermediate",
    tags: ["solid views", "projection", "non-unique reconstruction", "cube count", "orthographic views"],
    estimatedTime: "9 minutes",
    prerequisites: ["Orthographic projections", "Cube stacks", "Maximum"],
    learningOutcomes: ["Recognize projection equivalence", "Explain hidden cube ambiguity", "Use cube count as an extra reconstruction constraint"],
    componentKey: "NonUniqueSolidProjectionsProof",
  },
  {
...
const algebraProofs: AlgebraProofSeed[] = [
  ...
  },
  {
    ...
    slug: "absolute-value-inequality",
    shortDescription: "See an absolute-value inequality as distance from zero on a number line.",
    longDescription: "Move x and the radius r to compare values inside and outside a symmetric interval, connecting distance from zero to compound inequalities.",
    difficulty: "Beginner",
    tags: ["algebra", "absolute value", "inequality", "number line", "distance"],
    estimatedTime: "6 minutes",
    prerequisites: ["Number line", "Inequalities", "Absolute value"],
    learningOutcomes: ["Interpret absolute value as distance", "Recognize the symmetric interval", "Translate to a compound inequality"],
    componentKey: "AbsoluteValueInequalityProof",
  },
  {
    id: "equation-as-a-balance",
    title: "Equation as a Balance",
    slug: "equation-as-a-balance",
    shortDescription: "Solve a linear equation by keeping both sides of a balance equal.",
    longDescription: "Remove the same unit tiles from both pans, then split both remaining weights into equal groups to reveal the value of x.",
    difficulty: "Beginner",
    tags: ["algebra", "equation", "balance", "linear equation", "tiles"],
    estimatedTime: "7 minutes",
    prerequisites: ["Addition", "Division", "Equality"],
    learningOutcomes: ["Preserve equality with inverse operations", "Remove equal amounts from both sides", "Solve 2x + 3 = 11"],
    componentKey: "EquationAsBalanceProof",
  },
  {
...
const probabilityProofs: ProbabilityProofSeed[] = [
  ...
  },
  {
    ...
    slug: "de-morgans-law",
    shortDescription: "Compare complements of unions and intersections in a split Venn diagram.",
    longDescription: "A side-by-side shading comparison shows that outside A union B is exactly outside A and outside B, with the dual law for intersections.",
    difficulty: "Beginner",
    tags: ["sets", "logic", "Venn diagram", "complement", "De Morgan"],
    estimatedTime: "7 minutes",
    prerequisites: ["Sets", "Union", "Intersection", "Complement"],
    learningOutcomes: ["Visualize both De Morgan laws", "Match equivalent shaded regions", "Distinguish union and intersection"],
    componentKey: "DeMorgansLawProof",
  },
  {
    id: "counting-paths",
    title: "Counting Paths",
    slug: "counting-paths",
    shortDescription: "Count right-and-up lattice paths by adding the two incoming counts.",
    longDescription: "Each lattice node receives the sum of the path counts from the node below and the node to its left, building Pascal's triangle across a grid.",
    difficulty: "Beginner",
    tags: ["combinatorics", "paths", "Pascal triangle", "binomial coefficient", "grid"],
    estimatedTime: "8 minutes",
    prerequisites: ["Counting", "Addition"],
    learningOutcomes: ["Use the addition recurrence", "Count monotone lattice paths", "Connect paths to binomial coefficients"],
    componentKey: "CountingPathsProof",
  },
  {
...
const statisticsProofs: StatisticsProofSeed[] = [
  ...
  },
  {
    ...
    shortDescription: "Compare four very different data sets with nearly identical summary statistics.",
    longDescription: "Four scatterplots share the same means, correlation, and regression line, showing why data must be visualized as well as summarized.",
    difficulty: "Intermediate",
    tags: ["statistics", "scatterplot", "correlation", "regression", "data visualization"],
    estimatedTime: "9 minutes",
    prerequisites: ["Mean", "Correlation", "Scatterplots"],
    learningOutcomes: ["Compare matching statistics", "Notice different data shapes", "Explain why graphs matter"],
    componentKey: "AnscombesQuartetProof",
  },
  {
...
const sequenceSeriesProofs: SequenceSeriesProofSeed[] = [
  ...
  {
    id: "odd-numbers-build-squares-pattern",
    title: "Odd Numbers Build Squares Pattern",
    slug: "odd-numbers-build-squares-pattern",
    shortDescription: "Nest successive odd borders to grow square numbers.",
    longDescription: "Each new L-shaped border has 2n-1 tiles and wraps the previous square, creating the next n by n square.",
    difficulty: "Beginner",
    tags: ["patterns", "odd numbers", "square numbers", "layers"],
    estimatedTime: "7 minutes",
    prerequisites: ["Odd numbers", "Square numbers"],
    learningOutcomes: ["Identify nested odd borders", "Relate the nth border to 2n-1", "Build n squared"],
    componentKey: "OddNumbersBuildSquaresPatternProof",
  },
  {
  ...
  {
    id: "sum-consecutive-integers",
    title: "Sum of Consecutive Integers",
    slug: "sum-consecutive-integers",
    shortDescription: "Pair the first and last consecutive integers to reveal a constant average.",
    longDescription: "Every outside-in pair has sum 2k+n-1, so n consecutive integers total n(2k+n-1)/2.",
    difficulty: "Beginner",
    tags: ["series", "consecutive integers", "pairing", "average"],
    estimatedTime: "8 minutes",
    prerequisites: ["Consecutive integers", "Finite sums", "Average"],
    learningOutcomes: ["Pair outside terms", "Identify the middle value", "Derive the consecutive-integer sum"],
    componentKey: "SumConsecutiveIntegersProof",
  },
  {
  ...
  },
  {
    ...
    slug: "sierpinski-retained-area",
    shortDescription: "See why each carpet iteration keeps eight ninths of the previous area.",
    longDescription: "A square is divided into nine equal parts, the center part is removed, and the same rule repeats inside every retained square. The retained area follows (8/9)^n.",
    difficulty: "Beginner",
    tags: ["fractals", "sierpinski carpet", "area fraction", "geometric sequence", "self similarity"],
    estimatedTime: "8 minutes",
    prerequisites: ["Fractions", "Square area", "Powers"],
    learningOutcomes: ["Derive retained area as (8/9)^n", "Separate count scale from area scale", "Read self-similarity in the diagram"],
    componentKey: "SierpinskiRetainedAreaProof",
  },
  {
    id: "sierpinski-removed-square-sum",
    title: "Sierpinski Removed Square Sum",
    slug: "sierpinski-removed-square-sum",
    shortDescription: "Count the new holes at each step and sum them as a finite geometric series.",
    longDescription: "The first removed square is 1, then 8, then 64, and so on. The cumulative removed-square count is 1+8+...+8^(n-1)=(8^n-1)/7.",
    difficulty: "Intermediate",
    tags: ["fractals", "removed squares", "finite geometric sum", "sierpinski carpet"],
    estimatedTime: "9 minutes",
    prerequisites: ["Powers", "Geometric sequences", "Finite sums"],
    learningOutcomes: ["Count newly removed squares", "Compute cumulative removed squares", "Connect the pattern to finite GP sums"],
    componentKey: "SierpinskiRemovedSquareSumProof",
  },
  {
...
type BlueprintProofSeed = Omit<GeometryProofSeed, "componentKey"> & {
  categorySlug: string;
  level: string;
  componentKey?: VisualProofComponentKey;
};

const blueprintProofs: BlueprintProofSeed[] = [
  {
    id: "remainder-classes", title: "Remainder Classes", slug: "remainder-classes", categorySlug: "number-theory",
    shortDescription: "Sort positive and negative integers into congruence classes.", longDescription: "Integers belong to the same remainder class modulo n exactly when their difference is divisible by n. Vertical columns reveal the repeating pattern.", difficulty: "Beginner", level: "Middle School Mathematics", tags: ["modular arithmetic", "congruence classes", "remainders", "integers"], estimatedTime: "7 minutes", prerequisites: ["Remainders", "Negative residues"], learningOutcomes: ["Classify integers by remainder", "Recognize equivalent residues", "Explain periodic spacing by the modulus"], componentKey: "RemainderClassesProof",
  },
  {
    id: "negative-numbers-modulo-n", title: "Negative Numbers Modulo n", slug: "negative-numbers-modulo-n", categorySlug: "number-theory",
    shortDescription: "Walk backward around a residue clock to locate a negative integer's representative.", longDescription: "Moving backward k steps modulo n lands at the same residue as n−k. The clock connects negative integers to their least nonnegative residues.", difficulty: "Beginner", level: "Middle School Mathematics", tags: ["modular arithmetic", "negative numbers", "remainders", "clock"], estimatedTime: "7 minutes", prerequisites: ["Negative numbers", "Remainders"], learningOutcomes: ["Represent negative residues", "Move counterclockwise modulo n", "Find a least nonnegative representative"], componentKey: "NegativeNumbersModuloNProof",
  },
  {
    id: "multiplication-modulo-n", title: "Multiplication Modulo n", slug: "multiplication-modulo-n", categorySlug: "number-theory",
    shortDescription: "Repeat equal jumps around a residue circle to multiply modulo n.", longDescription: "Multiplication modulo n is repeated modular addition. Each equal jump adds the same residue, and the table records every landing position.", difficulty: "Beginner", level: "Middle School Mathematics", tags: ["modular arithmetic", "multiplication", "repeated addition", "clock"], estimatedTime: "7 minutes", prerequisites: ["Modular addition", "Multiplication"], learningOutcomes: ["Multiply residues by repeated addition", "Track modular positions", "Write a multiplication congruence"], componentKey: "MultiplicationModuloNProof",
  },
  {
    id: "addition-modulo-n", title: "Addition Modulo n", slug: "addition-modulo-n", categorySlug: "number-theory",
    shortDescription: "Join two walks around a residue circle and read the wrapped sum.", longDescription: "Modular addition follows ordinary addition while identifying numbers separated by the modulus. A second walk begins where the first ends and wraps around to the final residue.", difficulty: "Beginner", level: "Middle School Mathematics",
    tags: ["modular arithmetic", "addition", "clock", "remainders"], estimatedTime: "7 minutes", prerequisites: ["Remainders", "Addition"], learningOutcomes: ["Add residues on a clock", "Explain wrap-around", "Write a modular congruence"], componentKey: "AdditionModuloNProof",
  },
  {
    id: "fundamental-theorem-arithmetic-unique", title: "Fundamental Theorem of Arithmetic", slug: "fundamental-theorem-arithmetic-unique", categorySlug: "number-theory",
    shortDescription: "Split 360 in different ways and compare the same final prime factors.", longDescription: "Every integer greater than one has a prime factorization that is unique apart from order. Three different factor trees for 360 converge to the same multiset of prime leaves.", difficulty: "Intermediate", level: "Middle School to Olympiad Foundation",
    tags: ["prime factorization", "factor trees", "uniqueness", "number theory"], estimatedTime: "9 minutes", prerequisites: ["Prime numbers", "Factors"], learningOutcomes: ["Build different factor trees", "Compare their prime leaves", "State uniqueness up to order"], componentKey: "FundamentalArithmeticUniqueProof",
  },
  {
    id: "twin-primes-explorer", title: "Twin Primes Explorer", slug: "twin-primes-explorer", categorySlug: "number-theory",
    shortDescription: "Explore prime pairs separated by exactly two and their 6k±1 structure.", longDescription: "Twin primes differ by two. Apart from (3,5), every twin-prime pair has the form 6k−1 and 6k+1 because the integer between them is divisible by 6.", difficulty: "Intermediate", level: "Middle School to Olympiad Foundation",
    tags: ["prime", "twin primes", "modulo 6", "number patterns"], estimatedTime: "8 minutes", prerequisites: ["Prime numbers", "Multiples of 6"], learningOutcomes: ["Identify twin-prime pairs", "Verify their gap is 2", "Explain the 6k±1 pattern"], componentKey: "TwinPrimesExplorerProof",
  },
  {
    id: "prime-gaps-explorer", title: "Prime Gaps Explorer", slug: "prime-gaps-explorer", categorySlug: "number-theory",
    shortDescription: "Measure the spaces between consecutive primes on a number line.", longDescription: "Consecutive prime numbers define prime gaps. Move along the primes, zoom into the composite numbers between them, and compare gap sizes.", difficulty: "Beginner", level: "Middle School to Olympiad Foundation",
    tags: ["prime", "prime gaps", "number line", "patterns"], estimatedTime: "8 minutes", prerequisites: ["Prime numbers", "Number lines"], learningOutcomes: ["Calculate a prime gap", "Identify intervening composite numbers", "Compare gaps between consecutive primes"], componentKey: "PrimeGapsExplorerProof",
  },
  {
    id: "composite-factor-at-most-sqrt-n",
    title: "Composite Factor at Most √n",
    slug: "composite-factor-at-most-sqrt-n",
    categorySlug: "number-theory",
    shortDescription: "Follow factor pairs along ab = n and see why one factor must be at most √n.",
    longDescription: "Factor pairs lie on the reciprocal curve ab=n. If both factors were greater than √n, their product would exceed n, so every composite number has a non-trivial factor at most √n.",
    difficulty: "Intermediate",
    level: "Middle School to Olympiad Foundation",
    tags: ["composite", "factor pairs", "square root", "prime testing"],
    estimatedTime: "8 minutes",
    prerequisites: ["Factors", "Square roots", "Coordinate graphs"],
    learningOutcomes: ["Locate factor pairs on ab=n", "Explain the √n boundary", "Reduce prime testing to divisors at most √n"],
    componentKey: "CompositeFactorSqrtProof",
  },
  {
    ...
    categorySlug: "number-theory",
    shortDescription: "Cross out multiples of each prime to reveal every prime up to 100.",
    longDescription: "Starting with 2, repeatedly cross out multiples of the next uncrossed number. After 7, every remaining number greater than 1 is prime because 7 is the largest prime not exceeding the square root of 100.",
    difficulty: "Beginner",
    level: "Middle School Mathematics",
    tags: ["prime numbers", "sieve", "multiples", "Eratosthenes"],
    estimatedTime: "7 minutes",
    prerequisites: ["Multiples", "Prime numbers"],
    learningOutcomes: ["Generate primes to 100", "Explain why composite numbers are crossed out", "Recognize that sieving stops at the square root"],
    componentKey: "SieveEratosthenesProof",
  },
  {
    id: "gcd-lcm-product-relation",
    title: "GCD-LCM Product Relation: gcd(a,b) x lcm(a,b) = ab",
    slug: "gcd-lcm-product-relation",
    categorySlug: "number-theory",
    shortDescription: "Separate prime-factor blocks into shared and unshared factors to see why the product is ab.",
    longDescription: "Prime-factor tiles show each shared factor once in the GCD and the remaining factors in the LCM, so multiplying both recovers every factor of a and b exactly once.",
    difficulty: "Intermediate",
    level: "Middle School to Olympiad Foundation",
    tags: ["gcd", "lcm", "prime factors", "number theory", "factorization"],
    estimatedTime: "9 minutes",
    prerequisites: ["Prime factorization", "GCD", "LCM"],
    learningOutcomes: ["Connect GCD and LCM through factors", "Avoid double counting shared factors", "Explain gcd(a,b) x lcm(a,b) = ab"],
    componentKey: "GcdLcmRelationshipProof",
  },
  {
    id: "divisibility-by-11",
    title: "Divisibility by 11",
    slug: "divisibility-by-11",
    categorySlug: "number-theory",
    shortDescription: "Place alternating digits into positive and negative columns and compare the difference.",
    longDescription: "Because powers of 10 alternate between 1 and -1 modulo 11, the alternating digit sum has the same remainder as the original number.",
    difficulty: "Intermediate",
    level: "Middle School to Olympiad Foundation",
    tags: ["divisibility", "modular arithmetic", "digits", "number theory"],
    estimatedTime: "8 minutes",
    prerequisites: ["Place value", "Remainders", "Modular arithmetic"],
    learningOutcomes: ["Use alternating digit sums", "Explain why powers of 10 alternate modulo 11", "Test divisibility by 11 visually"],
    componentKey: "DivisibilityRuleElevenProof",
  },
  {
    id: "divisibility-rules-5-10", title: "Divisibility Rules for 5 and 10", slug: "divisibility-rules-5-10", categorySlug: "number-theory",
    shortDescription: "Sort numbers by their final digit into multiples of 5 and 10.", longDescription: "Multiples of 5 end in 0 or 5; multiples of 10 end in 0.", difficulty: "Beginner", level: "Middle School Mathematics",
    tags: ["divisibility", "last digit", "multiples"], estimatedTime: "6 minutes", prerequisites: ["Place value", "Multiples"], learningOutcomes: ["Test divisibility by 5", "Test divisibility by 10", "Compare the two rules"], componentKey: "DivisibilityRulesFiveTenProof",
  },
  {
    id: "last-digit-parity", title: "Last Digit Determines Parity", slug: "last-digit-parity", categorySlug: "number-theory",
    shortDescription: "Separate paired higher place-value blocks from the final units digit.", longDescription: "Every multiple of ten is even, so a whole number has the same parity as its units digit.", difficulty: "Beginner", level: "Middle School Mathematics",
    tags: ["parity", "even", "odd", "last digit", "place value"], estimatedTime: "6 minutes", prerequisites: ["Place value", "Even and odd numbers"], learningOutcomes: ["Classify parity from the units digit", "Explain why higher places are even", "Connect parity to 2k and 2k+1"], componentKey: "LastDigitParityProof",
  },
  {
    id: "multiples-number-line", title: "Multiples on the Number Line", slug: "multiples-number-line", categorySlug: "number-theory",
    shortDescription: "Compare equal jumps for two numbers and locate their shared landing points.", longDescription: "Repeated jumps mark multiples; points reached by both jump sizes are common multiples.", difficulty: "Beginner", level: "Middle School Mathematics",
    tags: ["multiples", "number line", "skip counting", "common multiples"], estimatedTime: "7 minutes", prerequisites: ["Multiplication", "Number lines"], learningOutcomes: ["Generate multiples by jumps", "Identify common multiples", "Compare two step sizes"], componentKey: "MultiplesNumberLineProof",
  },
  {
    id: "gcd-largest-equal-grouping", title: "GCD Through Largest Equal Grouping", slug: "gcd-largest-equal-grouping", categorySlug: "number-theory",
    shortDescription: "Partition two quantities into equal-sized groups and maximize the group size.", longDescription: "Common divisors make equal groups in both quantities; the largest valid size is the GCD.", difficulty: "Beginner", level: "Middle School Mathematics",
    tags: ["gcd", "equal groups", "factors", "division"], estimatedTime: "7 minutes", prerequisites: ["Factors", "Division"], learningOutcomes: ["Test common group sizes", "Recognize invalid remainders", "Identify the greatest common divisor"], componentKey: "GcdEqualGroupingProof",
  },
  {
    id: "divisibility-by-2",
    title: "Divisibility Rule for 2",
    slug: "divisibility-by-2",
    categorySlug: "number-theory",
    shortDescription: "Inspect the ones digit to decide whether a number is even.",
    longDescription: "Every higher place value is a multiple of 2, so only the final digit controls divisibility by 2.",
    difficulty: "Beginner",
    level: "Middle School Mathematics",
    tags: ["divisibility", "even numbers", "ones digit", "place value"],
    estimatedTime: "6 minutes",
    prerequisites: ["Place value", "Even numbers"],
    learningOutcomes: ["Use the final digit", "Classify even and odd numbers", "Explain why higher places do not matter"],
    componentKey: "DivisibilityRuleTwoProof",
  },
  {
    ...
    categorySlug: "number-theory",
    shortDescription: "Break a number into place-value blocks and show that every power of 10 has remainder 1 modulo 3.",
    longDescription: "Place-value blocks collapse to their digit counts because 10, 100, 1000, and higher powers all leave remainder 1 modulo 3.",
    difficulty: "Beginner",
    level: "Middle School to Olympiad Foundation",
    tags: ["divisibility", "digits", "modular arithmetic", "number theory"],
    estimatedTime: "7 minutes",
    prerequisites: ["Place value", "Remainders", "Digit sum"],
    learningOutcomes: ["Explain the divisibility-by-3 rule", "Connect place value to remainders", "Compare number remainder with digit-sum remainder"],
    componentKey: "DivisibilityRuleThreeProof",
  },
  {
    id: "divisibility-by-4",
    title: "Divisibility Rule for 4",
    slug: "divisibility-by-4",
    categorySlug: "number-theory",
    shortDescription: "Isolate the final two digits and group them into fours.",
    longDescription: "Every multiple of 100 is divisible by 4, so only the number formed by the tens and ones digits affects the remainder.",
    difficulty: "Beginner",
    level: "Middle School Mathematics",
    tags: ["divisibility", "place value", "last two digits", "remainders"],
    estimatedTime: "7 minutes",
    prerequisites: ["Place value", "Division by 4"],
    learningOutcomes: ["Use the final two digits", "Group into fours", "Explain why hundreds do not matter"],
    componentKey: "DivisibilityRuleFourProof",
  },
  {
    id: "divisibility-by-8",
    title: "Divisibility Rule for 8",
    slug: "divisibility-by-8",
    categorySlug: "number-theory",
    shortDescription: "Isolate the final three digits and group them into eights.",
    longDescription: "Every multiple of 1000 is divisible by 8, so only the final three-digit block controls divisibility by 8.",
    difficulty: "Beginner",
    level: "Middle School Mathematics",
    tags: ["divisibility", "last three digits", "place value", "remainders"],
    estimatedTime: "7 minutes",
    prerequisites: ["Place value", "Division by 8"],
    learningOutcomes: ["Use the final three digits", "Group into eights", "Explain why thousands do not matter"],
    componentKey: "DivisibilityRuleEightProof",
  },
  {
    ...
    categorySlug: "number-theory",
    shortDescription: "Move place-value remainders into a digit-sum tray and test the sum.",
    longDescription: "Since every power of 10 leaves remainder 1 modulo 9, a number and its digit sum always have the same remainder modulo 9.",
    difficulty: "Beginner",
    level: "Middle School to Olympiad Foundation",
    tags: ["divisibility", "digits", "modular arithmetic", "number theory"],
    estimatedTime: "7 minutes",
    prerequisites: ["Place value", "Remainders", "Digit sum"],
    learningOutcomes: ["Explain the divisibility-by-9 rule", "Use a digit-sum tray", "Compare number remainder with digit-sum remainder"],
    componentKey: "DivisibilityRuleNineProof",
  },
  {
    id: "even-number-sum",
    title: "Sum of First n Even Numbers: 2 + 4 + ... + 2n = n(n + 1)",
    slug: "sum-first-n-even-numbers",
    categorySlug: "sequences-and-series",
    shortDescription: "Combine two triangular dot patterns into an n by n+1 rectangle.",
    longDescription: "Even-number rows are doubled triangular rows. Pairing them forms a rectangle with side lengths n and n+1.",
    difficulty: "Beginner",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "series", "even numbers", "triangular numbers", "rectangle"],
    estimatedTime: "7 minutes",
    prerequisites: ["Counting arrays", "Triangular numbers", "Rectangle area"],
    learningOutcomes: ["See even sums as doubled triangles", "Build n(n+1) visually", "Connect number patterns to area"],
    componentKey: "SumFirstNEvenNumbersProof",
  },
  {
    id: "consecutive-square-difference",
    title: "Difference of Consecutive Squares: (n + 1)^2 - n^2 = 2n + 1",
    slug: "difference-consecutive-squares",
    categorySlug: "sequences-and-series",
    shortDescription: "Compare nested squares and highlight the newly added L-shaped border.",
    longDescription: "Growing an n by n square to an n+1 by n+1 square adds one row, one column, and one corner, making 2n+1 new tiles.",
    difficulty: "Beginner",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "square numbers", "odd numbers", "area", "tiles"],
    estimatedTime: "7 minutes",
    prerequisites: ["Square numbers", "Area of square", "Counting tiles"],
    learningOutcomes: ["Read square differences as borders", "Explain the odd-number growth rule", "Connect nested squares to 2n+1"],
    componentKey: "DifferenceConsecutiveSquaresProof",
  },
  {
    id: "exponent-product-rule",
    title: "Exponent Product Rule: a^m a^n = a^(m+n)",
    slug: "exponent-product-rule",
    categorySlug: "logarithms-exponents",
    shortDescription: "Join two chains of identical factor blocks and count the combined factors.",
    longDescription: "Repeated multiplication makes exponents visible as factor counts. Joining an m-chain and an n-chain produces m+n copies of the same base.",
    difficulty: "Beginner",
    level: "High School to Engineering Precalculus Foundations",
    tags: ["exponent", "product rule", "repeated multiplication", "growth-scale"],
    estimatedTime: "7 minutes",
    prerequisites: ["Multiplication", "Exponents", "Same base"],
    learningOutcomes: ["Count factor blocks", "Distinguish same-base products from unlike bases", "Explain a^m a^n = a^(m+n)"],
    componentKey: "ProductOfPowersProof",
  },
  {
    id: "exponent-quotient-rule",
    title: "Exponent Quotient Rule: a^m / a^n = a^(m-n)",
    slug: "exponent-quotient-rule",
    categorySlug: "logarithms-exponents",
    shortDescription: "Cancel matching numerator and denominator factor blocks.",
    longDescription: "A fraction of equal-base factor chains cancels one matching base at a time, leaving the difference between the factor counts.",
    difficulty: "Beginner",
    level: "High School to Engineering Precalculus Foundations",
    tags: ["exponent", "quotient rule", "cancellation", "repeated multiplication"],
    estimatedTime: "7 minutes",
    prerequisites: ["Fractions", "Cancellation", "Exponents"],
    learningOutcomes: ["Use cancellation visually", "State the nonzero-base condition", "Explain exponent subtraction"],
  },
  {
    id: "power-of-a-power-rule",
    title: "Power of a Power: (a^m)^n = a^(mn)",
    slug: "power-of-a-power-rule",
    categorySlug: "logarithms-exponents",
    shortDescription: "Display n groups, each containing m identical factors, then flatten them.",
    longDescription: "A power raised to another power is a grid of factor groups. Flattening n groups of m factors gives mn repeated factors.",
    difficulty: "Beginner",
    level: "High School to Engineering Precalculus Foundations",
    tags: ["exponent", "power rule", "groups", "repeated multiplication"],
    estimatedTime: "7 minutes",
    prerequisites: ["Exponents", "Multiplication arrays", "Repeated multiplication"],
    learningOutcomes: ["Flatten grouped powers", "Connect groups to multiplication", "Explain (a^m)^n = a^(mn)"],
  },
  {
    id: "zero-exponent-rule",
    title: "Zero Exponent Rule: a^0 = 1",
    slug: "zero-exponent-rule",
    categorySlug: "logarithms-exponents",
    shortDescription: "Cancel all factors in a^n / a^n, leaving the multiplicative identity.",
    longDescription: "Equal factor chains in numerator and denominator cancel completely. The remaining empty product is the identity value 1, for nonzero a.",
    difficulty: "Beginner",
    level: "High School to Engineering Precalculus Foundations",
    tags: ["exponent", "zero exponent", "identity", "cancellation"],
    estimatedTime: "6 minutes",
    prerequisites: ["Division", "Nonzero base", "Exponent quotient rule"],
    learningOutcomes: ["Explain why a^0 is 1", "Name the nonzero-base condition", "Connect zero exponent to cancellation"],
  },
  {
    id: "negative-exponent-rule",
    title: "Negative Exponent Rule: a^(-n) = 1 / a^n",
    slug: "negative-exponent-rule",
    categorySlug: "logarithms-exponents",
    shortDescription: "Extend an exponent table where every step divides by a.",
    longDescription: "Moving left on an exponent table divides by the base each step, so crossing from a^0 to a^-n places the repeated factors in the denominator.",
    difficulty: "Intermediate",
    level: "High School to Engineering Precalculus Foundations",
    tags: ["exponent", "negative exponent", "reciprocal", "growth-scale"],
    estimatedTime: "8 minutes",
    prerequisites: ["Reciprocals", "Zero exponent", "Exponent tables"],
    learningOutcomes: ["Read negative powers from a table", "Connect negative exponents to reciprocals", "State the nonzero-base condition"],
  },
  {
    id: "sum-of-cubes-identity",
    title: "Sum of Cubes: a^3 + b^3 = (a + b)(a^2 - ab + b^2)",
    slug: "sum-of-cubes-identity",
    categorySlug: "algebraic-identities",
    shortDescription: "Use layered cuboids or signed algebra tiles to balance the added and removed regions.",
    longDescription: "A signed volume model starts with an a+b factor and uses compensating ab layers so the remaining expression multiplies to a^3+b^3.",
    difficulty: "Advanced",
    level: "School to Foundation Algebra",
    tags: ["algebra", "identity", "cube", "volume model", "factorization"],
    estimatedTime: "11 minutes",
    prerequisites: ["Cube volume", "Distributive law", "Signed regions"],
    learningOutcomes: ["Factor a sum of cubes", "Interpret the negative middle term", "Connect algebraic signs to compensating regions"],
  },
  {
    id: "exterior-angle-sum-polygon",
    title: "Exterior Angle Sum of a Polygon: 360 degrees",
    slug: "exterior-angle-sum-polygon",
    categorySlug: "geometry",
    shortDescription: "Walk around a polygon and accumulate each turning angle.",
    longDescription: "As a walker turns once around any polygon, the total direction change is exactly one full turn, so the exterior angles sum to 360 degrees.",
    difficulty: "Intermediate",
    level: "School to Engineering Foundation",
    tags: ["polygon", "exterior angles", "turning", "360 degrees", "geometry"],
    estimatedTime: "8 minutes",
    prerequisites: ["Angles", "Polygons", "Full turn"],
    learningOutcomes: ["Use turning angles", "Explain independence from side lengths", "Derive exterior-angle sum"],
  },
  {
    id: "herons-formula-visual-proof",
    title: "Heron's Formula",
    slug: "herons-formula-visual-proof",
    categorySlug: "geometry",
    shortDescription: "Rearrange triangle components and track semiperimeter stages.",
    longDescription: "A visual derivation relates side lengths, altitude, and semiperimeter pieces until the area becomes sqrt(s(s-a)(s-b)(s-c)).",
    difficulty: "Advanced",
    level: "School to Engineering Foundation",
    tags: ["triangle", "area", "semiperimeter", "heron", "geometry"],
    estimatedTime: "12 minutes",
    prerequisites: ["Triangle area", "Pythagorean theorem", "Algebraic manipulation"],
    learningOutcomes: ["Define semiperimeter", "Connect side lengths to altitude", "Explain the structure of Heron's formula"],
  },
  {
    id: "pyramid-volume-one-third",
    title: "Volume of a Pyramid: V = (1/3)Bh",
    slug: "pyramid-volume-one-third",
    categorySlug: "mensuration",
    shortDescription: "Fill a matching prism using three congruent pyramids.",
    longDescription: "A prism with the same base area and height decomposes into three equal-volume pyramids, so one pyramid has one third of the prism volume.",
    difficulty: "Intermediate",
    level: "School to Competitive Exam Mensuration",
    tags: ["pyramid", "volume", "prism", "mensuration", "3d"],
    estimatedTime: "9 minutes",
    prerequisites: ["Prism volume", "Base area", "Height"],
    learningOutcomes: ["Compare pyramid and prism volume", "Explain the one-third factor", "Use base area times height"],
  },
  {
    id: "shoelace-formula",
    title: "Shoelace Formula",
    slug: "shoelace-formula",
    categorySlug: "coordinate-geometry",
    shortDescription: "Draw cross-products as diagonals between coordinate columns and compare signed areas.",
    longDescription: "Writing coordinates in a loop creates two diagonal product sums. Their signed difference equals twice the polygon area.",
    difficulty: "Advanced",
    level: "High School to Engineering Foundation",
    tags: ["coordinate geometry", "area", "determinant", "polygon", "shoelace"],
    estimatedTime: "10 minutes",
    prerequisites: ["Coordinate plane", "Determinants", "Triangle area from coordinates"],
    learningOutcomes: ["Compute signed polygon area", "Interpret cross-products visually", "Connect shoelace to determinants"],
  },
  {
    id: "integral-power-zero-one",
    title: "Power Integral on [0,1]: integral_0^1 x^n dx = 1/(n+1)",
    slug: "integral-power-zero-one",
    categorySlug: "calculus",
    shortDescription: "Show areas under successive power curves or use a dimensional partition model.",
    longDescription: "The unit interval power curve can be compared with n+1 dimensional slices, making the reciprocal 1/(n+1) area relationship visible.",
    difficulty: "Advanced",
    level: "High School to Engineering Mathematics",
    tags: ["calculus", "integral", "power rule", "area under curve"],
    estimatedTime: "10 minutes",
    prerequisites: ["Definite integrals", "Power functions", "Area under a curve"],
    learningOutcomes: ["Read the integral as area", "Compare power curves", "Explain the 1/(n+1) result"],
  },
  {
    id: "bayes-theorem-tree-reversal",
    title: "Bayes' Theorem",
    slug: "bayes-theorem-tree-reversal",
    categorySlug: "probability",
    shortDescription: "Use a probability tree and reverse from cause-to-outcome to outcome-to-cause.",
    longDescription: "A two-stage tree shows joint probabilities at the leaves. Conditioning on the observed outcome renormalizes the relevant leaves to reverse the question.",
    difficulty: "Advanced",
    level: "School to Engineering Probability Foundation",
    tags: ["probability", "bayes theorem", "conditional probability", "tree diagram"],
    estimatedTime: "11 minutes",
    prerequisites: ["Conditional probability", "Tree diagrams", "Joint probability"],
    learningOutcomes: ["Reverse conditional probability", "Use joint-probability leaves", "Explain normalization by the observed event"],
  },
  {
    id: "binomial-mean",
    title: "Binomial Mean: E(X) = np",
    slug: "binomial-mean",
    categorySlug: "probability",
    shortDescription: "Show n Bernoulli trials, each contributing expected value p.",
    longDescription: "Each success indicator has expected value p. Adding n independent indicators stacks n equal expectation contributions, giving np.",
    difficulty: "Intermediate",
    level: "School to Engineering Probability Foundation",
    tags: ["probability", "binomial distribution", "expected value", "bernoulli trials"],
    estimatedTime: "8 minutes",
    prerequisites: ["Expected value", "Bernoulli trial", "Linearity of expectation"],
    learningOutcomes: ["Model a binomial variable as indicators", "Add expected contributions", "Explain E(X)=np"],
  },
  {
    id: "binomial-variance",
    title: "Binomial Variance: np(1-p)",
    slug: "binomial-variance",
    categorySlug: "probability",
    shortDescription: "Add independent Bernoulli variances visually.",
    longDescription: "Each independent Bernoulli trial contributes variance p(1-p). Independent contributions add to n p(1-p).",
    difficulty: "Advanced",
    level: "School to Engineering Probability Foundation",
    tags: ["probability", "binomial distribution", "variance", "bernoulli trials"],
    estimatedTime: "9 minutes",
    prerequisites: ["Variance", "Independence", "Bernoulli trial"],
    learningOutcomes: ["See variance as spread contribution", "Use independence to add variances", "Explain np(1-p)"],
  },
  {
    id: "linear-independence-span-collapse",
    title: "Linear Independence",
    slug: "linear-independence-span-collapse",
    categorySlug: "matrices-linear-algebra",
    shortDescription: "Drag two vectors and show the spanned parallelogram collapsing when they align.",
    longDescription: "Independent vectors span a nonzero-area parallelogram. When one vector becomes a multiple of the other, the area collapses and one direction is lost.",
    difficulty: "Intermediate",
    level: "High School to Engineering Linear Algebra",
    tags: ["linear algebra", "vectors", "span", "independence", "determinant"],
    estimatedTime: "9 minutes",
    prerequisites: ["Vectors", "Span", "Determinant as area"],
    learningOutcomes: ["Recognize dependent directions", "Connect area collapse to determinant zero", "Explain linear independence visually"],
  },
  {
    id: "cramers-rule-determinants",
    title: "Cramer's Rule",
    slug: "cramers-rule-determinants",
    categorySlug: "matrices-linear-algebra",
    shortDescription: "Compare determinant-scaled parallelogram areas.",
    longDescription: "Replacing one matrix column by the target vector compares area-scaling factors, so coordinate solutions become determinant ratios.",
    difficulty: "Advanced",
    level: "High School to Engineering Linear Algebra",
    tags: ["linear algebra", "determinants", "systems", "cramers rule", "area"],
    estimatedTime: "11 minutes",
    prerequisites: ["Linear systems", "Determinants", "Matrix transformations"],
    learningOutcomes: ["Interpret determinant ratios", "Connect column replacement to target vectors", "Explain when Cramer's rule applies"],
  },
  {
    id: "rank-transformation-dimension",
    title: "Rank as Remaining Independent Directions",
    slug: "rank-transformation-dimension",
    categorySlug: "matrices-linear-algebra",
    shortDescription: "Show how many independent directions remain after a transformation.",
    longDescription: "A matrix transformation can preserve a plane, collapse it to a line, or collapse it to a point. Rank counts the independent output directions left.",
    difficulty: "Advanced",
    level: "High School to Engineering Linear Algebra",
    tags: ["linear algebra", "rank", "matrix transformation", "dimension", "span"],
    estimatedTime: "10 minutes",
    prerequisites: ["Matrix transformations", "Span", "Linear independence"],
    learningOutcomes: ["Connect rank to image dimension", "See collapses under transformations", "Relate rank to independent columns"],
  },
  {
    id: "binomial-theorem-pascal-expansion",
    title: "Binomial Theorem",
    slug: "binomial-theorem-pascal-expansion",
    categorySlug: "sequences-and-series",
    shortDescription: "Expand an area or cube model, then connect coefficients to Pascal's triangle.",
    longDescription: "Repeated multiplication of a+b creates paths choosing a or b at each factor. Counting equal-choice paths gives the binomial coefficients.",
    difficulty: "Intermediate",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "series", "binomial theorem", "pascal triangle", "combinatorics"],
    estimatedTime: "10 minutes",
    prerequisites: ["Pascal's triangle", "Combinations", "Polynomial expansion"],
    learningOutcomes: ["Connect coefficients to choices", "Use Pascal's triangle", "Explain why matching terms combine"],
  },
  {
    id: "pascal-identity-subset-split",
    title: "Pascal Identity: C(n,r) = C(n-1,r-1) + C(n-1,r)",
    slug: "pascal-identity-subset-split",
    categorySlug: "sequences-and-series",
    shortDescription: "Split subsets into those containing a selected object and those not containing it.",
    longDescription: "Choosing r objects from n can be counted by first deciding whether a named object is included. The include and exclude cases form the two entries above in Pascal's triangle.",
    difficulty: "Intermediate",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "combinatorics", "pascal triangle", "binomial coefficients", "counting"],
    estimatedTime: "8 minutes",
    prerequisites: ["Combinations", "Pascal's triangle", "Case splitting"],
    learningOutcomes: ["Explain Pascal's recurrence", "Split choices into include/exclude cases", "Connect subset counts to triangle entries"],
  },
  {
    id: "sum-of-cubes-square-triangular",
    title: "Sum of Cubes: 1^3 + 2^3 + ... + n^3 = [n(n+1)/2]^2",
    slug: "sum-of-cubes-square-triangular",
    categorySlug: "sequences-and-series",
    shortDescription: "Arrange cubes or layered dot patterns into a square of the triangular number.",
    longDescription: "The first n cubes can be layered into a square whose side length is the nth triangular number, revealing the square on the right side.",
    difficulty: "Advanced",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "series", "sum of cubes", "triangular numbers", "area"],
    estimatedTime: "11 minutes",
    prerequisites: ["Triangular numbers", "Square numbers", "Summation notation"],
    learningOutcomes: ["Connect cube sums to triangular numbers", "Read the square structure visually", "Explain the identity"],
  },
  {
    id: "telescoping-series-cancellation",
    title: "Telescoping Series",
    slug: "telescoping-series-cancellation",
    categorySlug: "sequences-and-series",
    shortDescription: "Animate cancellation of consecutive positive and negative terms.",
    longDescription: "Adjacent terms cancel in pairs, so the long sum collapses to only the first and last surviving pieces.",
    difficulty: "Intermediate",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "series", "telescoping", "cancellation", "partial sums"],
    estimatedTime: "8 minutes",
    prerequisites: ["Series notation", "Partial sums", "Algebraic cancellation"],
    learningOutcomes: ["Identify canceling neighbors", "Write partial sums", "Explain why only boundary terms remain"],
  },
  {
    id: "standard-deviation-effect",
    title: "Standard Deviation Effect",
    slug: "standard-deviation-effect",
    categorySlug: "statistics",
    shortDescription: "Change spread while keeping the mean fixed and observe the distribution widen.",
    longDescription: "A distribution can keep the same balance point while its data points move farther from the mean. Standard deviation measures that visible widening.",
    difficulty: "Beginner",
    level: "School to Engineering Statistics Foundation",
    tags: ["statistics", "standard deviation", "spread", "distribution", "mean"],
    estimatedTime: "8 minutes",
    prerequisites: ["Mean", "Variance", "Data distribution"],
    learningOutcomes: ["Separate center from spread", "Interpret standard deviation visually", "Compare narrow and wide distributions"],
  },
  {
    ...
    categorySlug: "statistics",
    shortDescription: "Repeatedly sample and animate the distribution of sample means becoming bell-shaped.",
    longDescription: "Sample means vary less than raw data, and repeated sampling makes their distribution approach a bell shape under broad conditions.",
    difficulty: "Advanced",
    level: "School to Engineering Statistics Foundation",
    tags: ["statistics", "central limit theorem", "sampling distribution", "sample mean", "normal distribution"],
    estimatedTime: "11 minutes",
    prerequisites: ["Mean", "Sampling", "Distributions"],
    learningOutcomes: ["Distinguish data distribution from mean distribution", "See sampling reduce spread", "Explain the bell-shaped limit idea"],
  },
  {
    id: "geometric-series-sum-one-over-one-minus-r",
    title: "Geometric-Series Sum: 1 + r + r^2 + ... = 1/(1-r)",
    slug: "geometric-series-sum-one-over-one-minus-r",
    categorySlug: "sequences-and-series",
    shortDescription: "Fill a square or bar using successively shrinking pieces.",
    longDescription: "Each new piece fills the same fraction of what remains. The infinite stack approaches a fixed total of 1/(1-r) when |r| is less than 1.",
    difficulty: "Intermediate",
    level: "High School to Engineering Mathematics",
    tags: ["sequence", "series", "geometric series", "infinite sum", "convergence"],
    estimatedTime: "9 minutes",
    prerequisites: ["Geometric progression", "Fractions", "Limits"],
    learningOutcomes: ["See convergence as filling a region", "Explain why |r| < 1 matters", "Connect the visual sum to 1/(1-r)"],
  },
];

const blueprintAvailableProofs: VisualProof[] = blueprintProofs.map((proof): VisualProof => ({
  ...proof,
  route: `/visual-proofs/${proof.categorySlug}/${proof.slug}`,
  status: "available",
  componentKey: proof.componentKey ?? "VisualProofBlueprintProof",
  thumbnailKey: proof.componentKey ?? "VisualProofBlueprintProof",
})).map(withUpgradeMetadata);
...
const plannedProofs: VisualProof[] = visualProofCategories
  ...
  .map((category): VisualProof => ({
    ...
    shortDescription: `A planned route for the first ${category.title.toLowerCase()} interactive proof build.`,
    longDescription:
      "This proof route is queued on the roadmap. It is listed so teachers can see planned coverage without implying an interactive proof is available today.",
    difficulty: "Intermediate",
    level: category.targetAudience,
    tags: [category.slug, "visual proof", "roadmap"],
    estimatedTime: "Roadmap",
