...
export type VisualProofComponentKey =
  ...
  | "OddNumbersBuildSquaresPatternProof"
  ...
  | "DifferenceConsecutiveSquaresProof"
  | "SumFirstNEvenNumbersProof"
  | "SumConsecutiveIntegersProof"
  | "DivisibilityRuleTwoProof"
  | "DivisibilityRuleThreeProof"
  | "DivisibilityRuleFourProof"
  | "DivisibilityRuleEightProof"
  | "DivisibilityRuleNineProof"
  | "DivisibilityRuleElevenProof"
  | "DivisibilityRulesFiveTenProof"
  | "LastDigitParityProof"
  | "MultiplesNumberLineProof"
  | "GcdEqualGroupingProof"
  | "GcdLcmRelationshipProof"
  | "SieveEratosthenesProof"
  | "CompositeFactorSqrtProof"
  | "PrimeGapsExplorerProof"
  | "TwinPrimesExplorerProof"
  | "FundamentalArithmeticUniqueProof"
  | "AdditionModuloNProof"
  | "MultiplicationModuloNProof"
  | "NegativeNumbersModuloNProof"
  | "RemainderClassesProof"
  | "ProductOfPowersProof"
