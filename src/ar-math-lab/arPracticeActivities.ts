export type ARPracticeActivity = {
  ...
  topic:
    "Surfaces" | "Curves" | "Solids" | "Planes" | "Measurement" | "Classroom";
  exampleId: string;
  goal: string;
  steps: string[];
  hints: string[];
  ...
  expectedActions: Array<
    "load" | "place" | "walk" | "measure" | "animate" | "compare" | "capture"
  >;
};
...
export const arPracticeActivities: ARPracticeActivity[] = [
  {
    ...
    steps: [
      "Load the wave surface.",
      "Place it in 3D Preview or AR.",
      "Rotate or walk around it.",
      "Find one peak, one valley, and one zero-height line.",
    ],
    hints: [
      "Peaks happen when sin(x) and sin(y) have the same sign.",
      "Look from above to see a checkerboard pattern.",
    ],
    evidencePrompt:
      "Write one sentence explaining why the surface has both hills and valleys.",
  ...
  },
  {
    ...
    steps: [
      "Load the paraboloid slice.",
      "Turn on labels and grid.",
      "Imagine a horizontal plane cutting the bowl.",
      "Predict the shape of the slice.",
    ],
    hints: [
      "All points with the same z-value have the same distance from the origin.",
      "That equal distance makes a circle.",
    ],
  ...
  },
  {
    ...
    steps: [
      "Load the cone.",
      "Generate a cylinder with radius 5 cm and height 12 cm.",
      "Use Compare mode.",
      "Read both volume formulas.",
    ],
    hints: [
      "The cone volume is one-third of the matching cylinder.",
      "Use the same radius and height before comparing.",
    ],
  ...
  },
  {
    ...
    steps: [
      "Load the helix.",
      "Use curve point markers.",
      "Rotate the scene.",
      "Describe how x, y, and z change as t increases.",
    ],
  ...
  },
  {
    ...
    steps: [
      "Measure radius and height of a cup or can.",
      "Enter those values in centimeters.",
      "Generate the solid.",
      "Compare the AR object to the real object.",
    ],
  ...
  },
  {
    ...
    steps: [
      "Load the saddle surface.",
      "Enable Teacher Mode.",
      "Ask students to inspect x-direction and y-direction curves.",
      "Compare with the paraboloid.",
    ],
    hints: [
      "A saddle rises in one direction and falls in another.",
      "The origin is not a maximum or minimum.",
    ],
    evidencePrompt:
      "Ask students to vote: maximum, minimum, or neither. Then justify.",
