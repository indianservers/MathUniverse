...
const PACK: Record<string, Record<string, ModePack>> = {
  identities: {
    ...
    "Double Angle": { learning: loop("Compare the gold θ ray with the purple 2θ ray.", "sin 2θ = 2 sinθ cosθ, not 2 sinθ.", "Double angle is the sum with φ = θ, so two matching products add.", "Snap to 30° or 45° and read exact values.", "sin(2×45°) = ?"), challenge: { prompt: "sin(2×45°) = ?", expected: 1, hint: "2θ = 90°." } },
